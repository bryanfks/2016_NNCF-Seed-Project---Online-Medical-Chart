...
<form name="china_medical" enctype="multipart/form-data" method="post" action="pakistanSave.php">
<div align="center">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></font>
			...
			<input type="checkbox" name="MSOther" value="1" <?PHP if($resultChinaPatientinfo['MSOther'] == "1"){ echo "checked"; } ?>>
					</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><span style='font-family:Times New Roman;mso-hansi-font-family:新細明體'>Other</span>s：</span><span style="font-family: Times New Roman"><font face="Times New Roman">
