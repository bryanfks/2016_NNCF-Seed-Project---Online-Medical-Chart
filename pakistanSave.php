<?PHP
	...
	if(!empty($seid) && !empty($sepwd)){
		...
		$chinapatient_sql ="UPDATE `PKpatient2` SET `remark` = '".$remark."' WHERE `NCFMedicalNum` = '".$NCFMedicalNum."' LIMIT 1";
		
		
		
		$selChinaPatientRecord = "SELECT * FROM `PKpatientrecord` WHERE NCFMedicalNum='".$NCFMedicalNum."'";
		...
		$chinapatientrecord_sql = "UPDATE `PKpatientrecord` SET `ncfCheck` = '".$ncfCheck."',`ncfAllMedicaid` = '".$ncfAllMedicaid."', `ncfAllTransport` = '".$ncfAllTransport."', `ncfAllTotal` = '".$ncfAllTotal."', `ncfAllRemark` = '".$ncfAllRemark."' WHERE `NCFMedicalNum` = '".$NCFMedicalNum."' LIMIT 1";	  
		...
		//echo $chinapatient_sql."<br/><br/>".$chinapatientrecord_sql;
			...
			echo "location.href='pakistanList.php'";
			echo "//-->";
			echo " </Script>";
			echo "</head>";
			echo "</html>";
