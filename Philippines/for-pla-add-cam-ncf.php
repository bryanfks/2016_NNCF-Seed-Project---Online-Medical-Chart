	...
	<head>
		...
		function saveData(opt){
			if(opt == "save"){
				...
				document.ppls_form.chkcode.value = "<?PHP echo $res_PatientRecord["chkcode"]; ?>";		/*	value: p+ne or pc+ne */
				...
				if ((chkcode_auths == "pc") || (chkcode_auths == "pcne")) {
					document.ppls_form.condition.value = "4";
					document.ppls_form.chkcode.value = "pnc";	// 表示國內醫師已經審閱完成，且經基金會審閱完成，可以關閉病歷表。
				} else if ((chkcode_auths == "pne") || (chkcode_auths == "p")) {
					document.ppls_form.condition.value = "4";
					document.ppls_form.chkcode.value = "pn";	// 表示基金會審閱完成，但是國內醫師未審閱。
				} 
          ...
          <tr>
            <td width="103%" align="center" bgcolor="#F7EBC6" valign="top">
                ...
                <table border="1" cellspacing="1" width="90%">
                  ...
                  <tr>
                    <td width="100%">
                      ...
                      Living allowance： <input type="text" name="ncf_livallowday" size="3" width="3" maxlength="1" value=""> day(s) * 2 USD per day</font></p>    
                              <p align="left" style="margin-left: 10; margin-right: 10">
                      ...
                      </font> <input type="text" name="ncf_traallowdist" size="5" width="5" maxlength="4" value=""><font size="2"> distance</font></font></p> 
                              <p align="left" style="margin-left: 10; margin-right: 10">
              ...
              <font color="#666666">Note：</font></p>          
                  ...
                  <?PHP 
				  		if(($res_PatientRecord["chkcode"] == "p" ) || ($res_PatientRecord["chkcode"] == "pne" ) || ($res_PatientRecord["chkcode"] == "pcne" ) || ($res_PatientRecord["chkcode"] == "pc" )) {  
					?>
                  <tr>
