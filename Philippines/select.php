                  ...
                  <tr>
                    <td width="20%" align="center">
                    	<font size="3" face="Arial">
                            ...
                            <?  if($idchk1 = "cn") echo "<option value='http://www.seed-nncf.org/Philippines/searchList.php'>List of Application</option>"; ?>
                            <option value="http://www.seed-nncf.org/Philippines/for-pla-add-china-search.php">Add New Application</option>
                        </select>
                        </font>
                    </td>
                    <td width="20%" align="center"><font size="3" face="Arial"><select size="1" name="select2" onChange="location = this.options[this.selectedIndex].value;">
                        ...
                        <?PHP /*<option value="oth-acc-rev.php">Edit Personal Info</option>*/ ?>
                    ...
                    <?PHP 
                    	...
                    	if(($auth_specialty == "ncfa") && ($auth_member == "a")){ 
                        	...
                        	echo "<option value='http://www.seed-nncf.org/Philippines/sys-add-acc.php'>Add Account</option>";
                        	echo "<option value='http://www.seed-nncf.org/Philippines/sys-mai-acc.php'>Edit Account</option>";
                        	echo "<option value='http://www.seed-nncf.org/Philippines/sys-del-acc.php'>Delete Account</option>";
                        	echo "<option value='http://www.seed-nncf.org/Philippines/sys-set-mes.php'>Set Real-time message</option>";
                        	echo "<option value='http://www.seed-nncf.org/Philippines/sys-assign.php'>Assign E-mail</option>";
                        	echo "<option value='http://www.seed-nncf.org/Philippines/sys-del-pat.php'>Delete Patient</option>";
                      		echo "</select>";
						*/
                      	}
                    ?></font></td>
