...
<?PHP               
	...
	if($pgValue == 1){               
		...
		$result_value = mysql_fetch_array($query);
		$auth  = $result_value['authority'];
		$country = $result_value['country'];
		$id2 = $result_value['id'];

		if(($result >= 1) && ($country != 'China') && ($country != 'Cambodia') && ($country != 'Pakistan') && ($country != 'Philippines') && ($country != 'Vietnam') || ($id2 == 'admin') || ($auth == 'n')){               
			$_SESSION["seid"] = $id;             
			$_SESSION["sepwd"] = $pwd;             
			...
			exit;
		}else if(($result >= 1) && ($country == 'Cambodia')){
			$_SESSION["seid"] = $id;             
			$_SESSION["sepwd"] = $pwd;             
			$_SESSION["country"] = $country;
			...
			echo "	location.href = \"http://www.seed-nncf.org/cambodia/main.php\" ;";
			echo "</script>";               
			exit;
		}else if(($result >= 1) && ($country == 'Pakistan')){
			$_SESSION["seid"] = $id;             
			$_SESSION["sepwd"] = $pwd;             
			$_SESSION["country"] = $country;
			...
			echo "<script language='JavaScript'>";               
			echo "	location.href = \"http://www.seed-nncf.org/pakistan/main.php\" ;";
			echo "</script>";               
			exit;
		}else if(($result >= 1) && ($country == 'Vietnam')){
			$_SESSION["seid"] = $id;             
			$_SESSION["sepwd"] = $pwd;             
			$_SESSION["country"] = $country;
			...
			echo "<script language='JavaScript'>";               
			echo "	location.href = \"http://www.seed-nncf.org/Vietnam/main.php\" ;";
			echo "</script>";               
			exit;
		}else if(($result >= 1) && ($country == 'Philippines')){
			$_SESSION["seid"] = $id;             
			$_SESSION["sepwd"] = $pwd;             
			$_SESSION["country"] = $country;
			...
			echo "<script language='JavaScript'>";               
			echo "	location.href = \"http://www.seed-nncf.org/Philippines/main.php\" ;";
			echo "</script>";               
			exit;
		}else {
			echo "<script language='JavaScript'>";               
