<?
	...
	if( (!empty($seid)) && (!empty($sepwd)) ){
		...
		if((!empty($srhValue))){
			$selChinaPatientinfo = "SELECT * FROM `PKpatient` WHERE `name` LIKE '".$srhValue."' OR `idno` LIKE '".$srhValue."' OR `MedicalRecordNumber` LIKE '".$srhValue."'"; 
			//屬廣泛搜尋法 ％：表示分配字元
...
<SCRIPT LANGUAGE="javascript">
	<!--
		...
		function fetch_Data(num){
			location.href = "for-pla-add-PK-cgmh_new.php?cpi="+num+"&srhType=<? echo $srhType; ?>&srhValue=<? echo $srhValue; ?>";
		}
		function addData(){
      ...
      <td width="100%">
        <div align="center">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-style: solid; border-width: 2" height="1">
            <tr>
              <td width="100%" height="16" align="center"><font size="2" face="Arial"><?PHP include("/home/customer/seed-nncf.org/www/pakistan/top.php"); ?></font></td>
            </tr>
            <tr>
              <td width="100%" height="16" align="center"><font size="2" face="Arial"><?PHP include("/home/customer/seed-nncf.org/www/pakistan/select.php"); ?></font></td>
            </tr>
