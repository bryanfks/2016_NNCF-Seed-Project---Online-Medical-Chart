<?PHP
	...
	if(!empty($seid) && !empty($sepwd)){
		...
		$queryChinaPatientinfo = mysql_query("SELECT * FROM `PKpatient` WHERE num =".$CPIData."");
		...
		*/
		...
		$qMaxNCFID = mysql_query("SELECT MAX(serialcode) FROM `PKpatientrecord` WHERE NCFID='".$resultChinaPatientinfo['NCFID']."'");
				...
				function saveData(opt){
					if(opt == "save"){
						...
						if(document.china_medical.caseYear.value == ""){
							...
							//location.href='rec-sea-list-PK-search.php';  //2014-12-19 修改
...
<form name="china_medical" enctype="multipart/form-data" method="post" action="for-pla-add-PK-cgmh-save2.php">
<div align="center">
					...
					(Pre-Surgery)</span><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span><span style='font-family:Times New Roman; mso-hansi-font-family:新細明體'><input type="text" name="beforeSurgeryYear" size="2" value="">/ <input type="text" name="beforeSurgeryMonth" size="1" value="">/ <input type="text" name="beforeSurgeryDay" size="1" value=""></span></font><div align="center">
						<table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="420">
							...
							<tr>
								...
								<td valign="top" align="center" width="345" height="210">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Others<br><input type="file" size="25" name="pedigree_graphics5"></font></span></td>
							</tr>
						</table>
					</div>
					<font size="4">
					...
					--Date (Post-Surgery)：<input type="text" name="afterSurgeryYear" size="2" value="">/ <input type="text" name="afterSurgeryMonth" size="1" value="">/ <input type="text" name="afterSurgeryDay" size="1" value=""></span></font><div align="center">
						<table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="420">
							...
							<tr>
								...
								<td valign="top" height="210" width="345" align="center">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Others<br><input type="file" size="25" name="pedigree_graphics8"></font></span></td>
							</tr>
						</table>
						</div>
					</td>
...
&nbsp; 2.</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Patient 
									...
									<span style="font-family: Times New Roman">
										<font face="Times New Roman" size="4">
											<input type="text" name="PatientSOT" size="6" value="">
                    					</font>
                                    </span>
                                	<br>
                                    <span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
			...
			<table border="1" width="700" cellspacing="1" cellpadding="0" id="table49" height="40">
				<tr>
					...
					&nbsp;</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">* 
									...
									<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
									<font size="4">Part 6C</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Others Receipt (1)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="210">
										<tr>
											<td valign="top" align="center"><br><input type="file" size="25" name="pedigree_graphics10"></td>
										</tr>
									</table>
									<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
									<font size="4">Part 6D</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Others Receipt (2)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="210">
										<tr>
											<td valign="top" align="center"><br><input type="file" size="25" name="pedigree_graphics11"></td>
										</tr>
									</table>
									<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
									<font size="4">Part 6E</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Others Receipt (3)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="210">
										<tr>
