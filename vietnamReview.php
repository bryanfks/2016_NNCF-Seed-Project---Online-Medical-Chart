...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href='css/VNViewPInfoContentAdmin.css'>
...
?>
                ...
                function saveData(opt){
                    if(opt == "save"){
                        ...
                        if(document.VNMedical.caseYear.value == ""){
                            ...
                            document.VNMedical.remark.value = "<? echo '2'; ?>";
                            document.VNMedical.num.value = "<? echo $CPIData; ?>";
                            document.VNMedical.submit();
                        }
                    }else if(opt == "cancels"){
    ...
    <body onLoad="inputData()">
        <form name="VNMedical" enctype="multipart/form-data" method="post" action="vietnamReviewSave.php">
        <header>
        ...
        <section>
            <div class="layer1">
                <?PHP require_once('vietnamReviewContent.php'); ?>
            </div>
        </section>
        <footer>
            <div>The  Web  Best  Browse  Mode ： Internet Explorer 9 (Or Update)  /  900 x 600  Resolution<br>
