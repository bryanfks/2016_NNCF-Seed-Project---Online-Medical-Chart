<?PHP
    ...
    if( (!empty($seid)) && (!empty($sepwd)) ){
      ...
      //搜尋語言治療病歷表  
      $sCNPatRec = "SELECT * FROM `patient_cn_lang_record` WHERE num = ".$CPIData2."";
      ...
      //echo $sCNPatRec."<br/>".$sCNPatInfo."<br/>";
?>
...
<FORM Enctype="multipart/form-data" method="post" name="china_medical" action="chinaview-st-save.php">
<DIV align=center>
<CENTER>
                      ...
                      <TD>
                        ...
                        <TABLE border=0 cellSpacing=1 width="100%" id="table61">
                          ...
                          <TR>
                            ...
                            <TD style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" width="32%">
                              <p style="line-height: 150%"><FONT size=3>&nbsp;平均每月生活支出 <?PHP echo $resultChinaPatientinfo['extimatedExpenditures']; ?><br/>(人民币)
                              </FONT>
                              </p>
                            </TD>
                          </TR>
  ...
  <div align="center">&nbsp;
    ...
    <FONT size=3>
      <p style="line-height: 150%">
                  ...
                  <td style="border-style: solid; border-width: 1">
    <p style="line-height: 150%">
                      <FONT size=3>&nbsp;NCF补助编号：<?PHP echo $resultChinaPatientRecord['NCFMedicalNum']; ?></FONT>
                    </p>
                  </td>
                </tr>
              </table>
                    ...
                    <table border="0" cellspacing="1" width="100%" id="table54">
                      <tr>
                        <td style="border-style: solid; border-width: 1">
                          ...
                          <p align="center" style="line-height: 150%" height="100%">
                              <font size="3">附件一：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other1']; ?>" alt="" height="" width="600px"><br></font>
                          </p>
                          <p align="center" style="line-height: 150%">
                            <FONT size=3>附件二：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other2']; ?>" alt="" height="" width="600px"><br></FONT>
                          </p>
                          <p align="center" style="line-height: 150%">
                            <FONT size=3>附件三：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other3']; ?>" alt="" height="" width="600px"><br></FONT>
                          </p>
                          <p align="center" style="line-height: 150%">
                            <FONT size=3>附件四：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other4']; ?>" alt="" height="" width="600px"><br></FONT>
                          </p>
                          <p align="center" style="line-height: 150%">
                            <FONT size=3>附件五：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other5']; ?>" alt="" height="" width="600px"><br></FONT>
                          </p>
                          <p align="center" style="line-height: 150%">
                            <FONT size=3>附件六：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other6']; ?>" alt="" height="" width="600px"><br></FONT>
                          </p>
                          <p align="center" style="line-height: 150%">
                            <FONT size=3>附件七：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other7']; ?>" alt="" height="" width="600px"><br></FONT>
                          </p>
                          <p align="center" style="line-height: 150%">
                            <FONT size=3>附件八：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other8']; ?>" alt="" height="" width="600px"><br></FONT>
                          </p>
                          <p align="center" style="line-height: 150%">
                            <FONT size=3>附件九：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other9']; ?>" alt="" height="" width="600px"><br>
                            </FONT>
                          </p>
                          <p align="center" style="line-height: 150%">
                            <FONT size=3>附件十：<img src="<?PHP echo $resultChinaPatientRecord['pedigree_graphics_other10']; ?>" alt="" height="" width="600px"><br>
                            </FONT>
                          </p>
     ...
     <DIV align="center">
            <TABLE border=0 cellSpacing=1 width="100%" id="table36">
              <TBODY>
                ...
                <tr>
                  <td style="border-style: solid; border-width: 1">
                    <p><font size="3">1. 医疗费用补助：人民币 <?PHP echo $resultChinaPatientRecord['ncfAllMedicaid']; ?> 元</font></p>
                  </td>
                </tr>
                <tr>
                  <td style="border-style: solid; border-width: 1">
                    <p><font size="3">2. 交通费用补助：人民币 <?PHP echo $resultChinaPatientRecord['ncfAllTransport']; ?> 元</font></p>
                  </td>
                </tr>
                <tr>
                  <td style="border-style: solid; border-width: 1">
                ...
                <tr>
                  <td style="border-style: solid; border-width: 1">
                    <p><font size="3">NCF 补助费用总金额为：人民币 <?PHP echo $resultChinaPatientRecord['ncfAllTotal']; ?> 元</font></p>
                  </td>
                </tr>
                <tr>
                  <td style="border-style: solid; border-width: 1">
                    <p><font size="3">意见：<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?PHP echo $resultChinaPatientRecord['ncfAllRemark']; ?></font></p>
                  </td>
                </tr>
                <tr>
                  <td style="border-style: solid; border-width: 1">
