<?PHP
	...
	if(!empty($seid) && !empty($sepwd)){
		...
		$selChinaPatientRecord = "SELECT * FROM `PHrecord` WHERE num='".$CPIData."'";
		...
		$selChinaPatientinfo = "SELECT * FROM `PHpatient` WHERE `NCFID`='".$resultChinaPatientRecord['NCFID']."'";
...
?>
					...
					/*
					document.china_medical.ncfAllMedicaid.value = "<?php echo $resultChinaPatientRecord['ncfAllMedicaid'];  ?>";
					document.china_medical.ncfAllTransport.value = "<?php echo $resultChinaPatientRecord['ncfAllTransport'];  ?>";
					document.china_medical.ncfAllTotal.value = "<?php echo $resultChinaPatientRecord['ncfAllTotal'];  ?>";
					document.china_medical.ncfAllRemark.value = "<?php echo $resultChinaPatientRecord['ncfAllRemark'];  ?>";
					*/
				...
				function saveData(opt){
					if(opt == "save"){
						...
						if(document.china_medical.caseYear.value == ""){
							...
							document.china_medical.ncfCheck.value = "<? echo 'Complete'; ?>";
							document.china_medical.num.value = "<? echo $CPIData; ?>";
							document.china_medical.submit();
						}
					}else if(opt == "cancels"){
...
<form name="china_medical" enctype="multipart/form-data" method="post" action="philippinesSave.php">
<div align="center">
					...
					<tr>
						<td height="20">
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-style: solid; border-width: 2" height="1">
                            	<tr>
              						<td width="100%" height="16" align="center"><font size="3" face="Arial"><?PHP include("/home/customer/seed-nncf.org/www/top.php"); ?></font></td>
            					</tr>
            					<tr>
              						<td width="100%" height="16" align="center"><font size="3" face="Arial"><?PHP include("/home/customer/seed-nncf.org/www/select.php"); ?></font></td>
            					</tr>
                            </table>
						</td>
					</tr>
					...
					(Pre-Surgery)</span><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span><span style='font-family:Times New Roman; mso-hansi-font-family:新細明體'><input type="text" name="beforeSurgeryYear" size="2" value="">/ <input type="text" name="beforeSurgeryMonth" size="1" value="">/ <input type="text" name="beforeSurgeryDay" size="1" value=""></span></font><div align="center">
						<table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="420">
							...
							<tr>
								...
								<td valign="top" align="center" width="345" height="210">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Other<br><img border="0" src="<?PHP if(!empty($resultChinaPatientRecord['pedigree_graphics5'])){ echo $resultChinaPatientRecord['pedigree_graphics5']; }else{ echo 'images/user-pic.jpg'; } ?>" alt="Pedigree" width="345" height="210" /><br><input type="file" size="25" name="pedigree_graphics5"></font></span></td>
							</tr>
						</table>
					</div>
					<font size="4">
					...
					--Date (Post-Surgery)：<input type="text" name="afterSurgeryYear" size="2">/ <input type="text" name="afterSurgeryMonth" size="1">/ <input type="text" name="afterSurgeryDay" size="1"></span></font><div align="center">
						<table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="420">
							...
							<tr>
								...
								<td valign="top" height="210" width="345" align="center">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Other<br><img src="<?PHP if(!empty($resultChinaPatientRecord['pedigree_graphics8'])){ echo $resultChinaPatientRecord['pedigree_graphics8']; }else{ echo 'images/user-pic.jpg'; } ?>" alt="Pedigree" border="0" width="345" height="210" /><br><input type="file" size="25" name="pedigree_graphics8"></font></span></td>
							</tr>
						</table>
						</div>
					</td>
...
&nbsp; 2.</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Patient 
				...
				<tr>
					...
					&nbsp;</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">* 
									...
									coordinator and program director)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="250">
										<tr>
											<td valign="top" align="center"><br><img border="0" src="<?PHP if(!empty($resultChinaPatientRecord['pedigree_graphics9'])){ echo $resultChinaPatientRecord['pedigree_graphics9']; }else{ echo 'images/user-pic.jpg'; } ?>" alt="Pedigree" width="690" height="250" /><br><input type="file" size="25" name="pedigree_graphics9"></td>
										</tr>
									</table>
									<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
									<font size="4">Part 6C</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Other receipt (1)</font></span>
									<table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="210">
										<tr>
											<td valign="top" align="center"><br><img border="0" src="<?PHP if(!empty($resultChinaPatientRecord['pedigree_graphics10'])){ echo $resultChinaPatientRecord['pedigree_graphics10']; }else{ echo 'images/user-pic.jpg'; } ?>" alt="Pedigree" width="690" height="250" /><br><input type="file" size="25" name="pedigree_graphics10"></td>
										</tr>
									</table>
									<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
									<font size="4">Part 6D</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Other receipt (2)</font></span>
									<table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="210">
										<tr>
											<td valign="top" align="center"><br><img border="0" src="<?PHP if(!empty($resultChinaPatientRecord['pedigree_graphics11'])){ echo $resultChinaPatientRecord['pedigree_graphics11']; }else{ echo 'images/user-pic.jpg'; } ?>" alt="Pedigree" width="690" height="250" /><br><input type="file" size="25" name="pedigree_graphics11"></td>
										</tr>
									</table>
									<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
									<font size="4">Part 6E</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Other receipt (3)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="210">
										<tr>
											<td valign="top" align="center"><br><img border="0" src="<?PHP if(!empty($resultChinaPatientRecord['pedigree_graphics12'])){ echo $resultChinaPatientRecord['pedigree_graphics12']; }else{ echo 'images/user-pic.jpg'; } ?>" alt="Pedigree" width="690" height="250" /><br><input type="file" size="25" name="pedigree_graphics12"></td>
										</tr>
									</table>
									</td>
								</tr>
    ...
    <table border="0" cellspacing="1" width="710">
		<?
			...
			//if(($MemberNCF2Check['NCF2Check'] == "1") || ($MemberNCF2Check['NCF2Check'] == 1)){
		?>
					<!--
                    <tr>
                    ...
                    <tr>
                    	<td style="border-style: solid; border-width: 1">
							<p><font size="3">1. 医疗费用补助：人民币<input type="text" size="4" name="ncfAllMedicaid" value=""> 元</font></p>
						</td>
					</tr>
                    <tr>
                    	<td style="border-style: solid; border-width: 1">
							<p><font size="3">2. 交通费用补助：人民币<input type="text" size="4" name="ncfAllTransport" value=""> 元</font></p>
						</td>
					</tr>
                    <tr>
                    	<td style="border-style: solid; border-width: 1">
                    ...
                    <tr>
                    	<td style="border-style: solid; border-width: 1">
							<p><font size="3">NCF 补助费用总金额为：人民币<input type="text" size="4" name="ncfAllTotal" value=""> 元</font></p>
						</td>
					</tr>
                    <tr>
                    	<td style="border-style: solid; border-width: 1">
							<p><font size="3">意见：<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="5" name="ncfAllRemark" cols="60" value=""></textarea></font></p>
						</td>
					</tr>
                    -->
				...
				<p align="center">
					<font size="3">
						<?
							...
							if(($resultChinaPatientRecord['ncfCheck'] == "Complete") || ($resultChinaPatientRecord['remark'] == "1") || ($resultChinaPatientRecord['remark'] == 1)){
								echo "<input id='previous0' onClick=\"return saveData('cancels')\" type='button' value='Back' name='save'>";
								//echo "NCF Check= ".$resultChinaPatientRecord['ncfCheck']."<br>Remark= ".$resultChinaPatientRecord['remark']."<br>Remark= ".$resultChinaPatientRecord['remark'];
							}else {
								echo "<input id='close0' onClick=\"return saveData('cancels')\" type='button' value='Cancel' name='close'>";
                    	    	echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                    	    	echo "<input id='close0' onClick=\"return saveData('sends')\" type='button' value='Approval' name='sends'>";
							}
...
<input type="hidden" name="ncfCheck" value="">
<input type="hidden" name="NCFID" value="<?php echo $resultChinaPatientinfo['NCFID'];  ?>">
<input type="hidden" name="NCFMedicalNum" value="<? echo $resultChinaPatientRecord['NCFMedicalNum']; ?>">
