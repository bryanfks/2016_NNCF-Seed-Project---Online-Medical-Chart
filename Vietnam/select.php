                  ...
                  <tr>
                    <td width="20%" align="center">
                    	<font size="3" face="Arial">
                            ...
                            <?  if($idchk1 = "cn") echo "<option value='http://www.seed-nncf.org/cambodia/searchList.php'>List of Application</option>"; ?>
                            <option value="http://www.seed-nncf.org/cambodia/for-pla-add-china-search.php">Add New Application</option>
                        </select>
                        </font>
                    </td>
                    ...
                    <?PHP 
                    	...
                    	if(($auth_specialty == "ncfa") && ($auth_member == "a")){ 
                        	...
                        	echo "<option value='http://www.seed-nncf.org/cambodia/sys-add-acc.php'>Add Account</option>";
                        	echo "<option value='http://www.seed-nncf.org/cambodia/sys-mai-acc.php'>Edit Account</option>";
                        	echo "<option value='http://www.seed-nncf.org/cambodia/sys-del-acc.php'>Delete Account</option>";
                        	echo "<option value='http://www.seed-nncf.org/cambodia/sys-set-mes.php'>Set Real-time message</option>";
                        	echo "<option value='http://www.seed-nncf.org/cambodia/sys-assign.php'>Assign E-mail</option>";
                        	echo "<option value='http://www.seed-nncf.org/cambodia/sys-del-pat.php'>Delete Patient</option>";
                      		echo "</select>";
						*/
                      	}
                    ?></font></td>
