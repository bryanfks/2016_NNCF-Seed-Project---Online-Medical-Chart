        ...
        <tr>
            <td style="vertical-align:middle;" class="TitleBar">
                <select size="1" name="hospital" title="">
                    ...
                    <option value="none">None Select Item</option>
                </select>
...
<div class="DiagnosisData">
    <table class="DiagnosisForm">
        ...
        <tr>
            <td colspan="4">
                * Main Diagnosis：<br>
                <label><input type="checkbox" name="diagnosis_unilateral_cleft_lip_1" value="UCL">Unilateral Cleft Lip</label>
                (
                    <label><input type="radio" name="diagnosis_unilateral_cleft_lip" value="C">Complete &nbsp;</label>
                    <label><input type="radio" name="diagnosis_unilateral_cleft_lip" value="IC">Incomplete &nbsp;</label>
                    <label><input type="radio" name="diagnosis_unilateral_cleft_lip" value="CK">Cracked &nbsp;</label>
                )<br>
                <label><input type="checkbox" name="diagnosis_bilateral_cleft_lip_2" value="BCL">Bilateral Cleft Lip &nbsp;</label>
                (
                <label><input type="radio" name="diagnosis_bilateral_cleft_lip" value="C">Complete &nbsp;</label>
                <label><input type="radio" name="diagnosis_bilateral_cleft_lip" value="IC">Incomplete &nbsp;</label>
                <label><input type="radio" name="diagnosis_bilateral_cleft_lip" value="MCK">Cracked &nbsp;</label>
                )<br>
                <label><input type="checkbox" name="CleftPalate" value="CP">Hard Palate ---</label>
                <label><input type="radio" name="incomplete_main" value="IC">Incomplete</label>
                (
                <label><input type="radio" name="incomplete" value="SCC">Submucosal Cleft &nbsp;</label>
                <label><input type="radio" name="incomplete" value="CU">Uvula Bifida &nbsp;</label>
                <label><input type="radio" name="incomplete" value="SP">Soft Palate &nbsp;</label>
                <label><input type="radio" name="incomplete" value="BC">Bilateral Cleft </label>
                )<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label><input type="radio" name="incomplete_main" value="C">Complete &nbsp;&nbsp;</label>
                (
                <label><input type="radio" name="complete" value="U">Unilateral &nbsp;</label>
                <label><input type="radio" name="complete" value="B">Bilateral </label>
                )<br>
                <label><input type="checkbox" name="BoneGraft_main" value="BoneGraft">Alveolar Cleft &nbsp;</label>
                (
                <label><input type="radio" name="BoneGraft_select" value="C">Complete &nbsp;</label>
                <label><input type="radio" name="BoneGraft_select" value="IC">Incomplete &nbsp;</label>
                <label><input type="radio" name="BoneGraft_select" value="CK">Cracked &nbsp;</label>
                )<br>
                <label><input type="checkbox" name="Combined_with_other_craniofacial_disorders" value="Other"> Combined with Other Craniofacial Deformities：<input type="text" size="60" maxlength="100"></label>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                * Did the patient have any treatment before?
                <label><input type="radio" name="" value="">Yes</label>
                <br>&nbsp;&nbsp;
                <label><input type="checkbox" name="beforeSurgery_1" value="1LNR">Primary Unilateral Lip/ Nose Repair</label>
                <label><input type="checkbox" name="beforeSurgery_2" value="1BLANR">Primary Bilateral Lip/ Nose Repair</label>
                <br>&nbsp;&nbsp;
                <label><input type="checkbox" name="beforeSurgery_3" value="1CPR">Primary Cleft Palate Repair</label>
                <label><input type="checkbox" name="beforeSurgery_4" value="FHR">Fistula Repair</label>
                <label><input type="checkbox" name="beforeSurgery_5" value="PF">Pharyngeal Flap Repair</label>
                <label><input type="checkbox" name="beforeSurgery_6" value="PBR">Vomer Flap Repair</label>
                <br>&nbsp;&nbsp;
                <label><input type="checkbox" name="beforeSurgery_7" value="2CPR">Secondary Cleft Palate Repair</label>
                <label><input type="checkbox" name="beforeSurgery_8" value="LR">Lip Rhinoplasty Repair</label>
                <br>&nbsp;&nbsp;
                <label><input type="checkbox" name="beforeSurgery_9" value="AB">Alveolar Bone Graft</label>
                <label><input type="checkbox" name="beforeSurgery_10" value="PO">Pre-Surgery Molding</label>
                <label><input type="checkbox" name="beforeSurgery_11" value="SL">Speech Therapy</label>
                <br>&nbsp;&nbsp;
                <label><input type="checkbox" name="beforeSurgery_other" value="other">Others, please specify：</label>
                <label><input type="text" size="85" maxlength="100" name="beforeSurgery_other_reason" value=""></label>
            </td>
        </tr>
    </table>
</div>
    ...
    <table style="text-align: center" class="ButtonZone">
        <tr class="ButtonZone">
            <td style="vertical-align:middle;" class="ButtonZone">
                <input type="button" name="Save" value="Save" style="border: 1px solid #73808c; width: 80px;" title="">
                <input type="button" name="Cancel" value="Cancel" style="border: 1px solid #73808c; width: 80px;" title="">
            </td>
        </tr>
    </table>
</div>