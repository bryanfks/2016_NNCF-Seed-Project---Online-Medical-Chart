...
<div class="FilesUpload">
    <table class="DiagnosisForm">
        ...
        <tr><td align="center" valign="top" height="500px" width="700px"><img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics9'])){ echo $resultPatientRecord['pedigree_graphics9']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="690" height="250"/><br><input type="file" name="pedigree_graphics9" size="25" title=""></td></tr>
        ...
        <tr class="ButtonZone">
            <td style="vertical-align:middle;" class="ButtonZone">
                ...
                <?php
                    ...
                    if(($resultPatientinfo['remark'] == "0") || ($resultPatientinfo['remark'] == 0) || (($resultPatientinfo['patientID'] != $seid)) || ($resultPatientinfo['remark'] == "2") || ($resultPatientinfo['remark'] == 2)){
