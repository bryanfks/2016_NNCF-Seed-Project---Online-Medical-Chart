<!-- <form name="VNMedical" enctype="multipart/form-data" method="post" action=".php"> -->
        ...
        <tr>
            <td style="vertical-align:middle;" class="TitleBar">
                <select size="1" name="hospital" title="">
                    ...
                    <option value="none" <?php if($resultPatientinfo['school'] == ""){ echo "selected"; } ?>>None Select Item</option>
                </select>
    ...
    <table class="DiagnosisForm">
        ...
        <tr>
            ...
            <td>
                ...
                <label><input type="radio" name="motherProfession" value="2" title="" <?php if($resultPatientinfo['motherProfession'] == "1"){ echo "checked"; } ?>>High School</label><br>
                <label><input type="radio" name="motherProfession" value="3" title="" <?php if($resultPatientinfo['motherProfession'] == "1"){ echo "checked"; } ?>>Elementary School</label><br>
                <label><input type="radio" name="motherProfession" value="4" title="" <?php if($resultPatientinfo['motherProfession'] == "1"){ echo "checked"; } ?>>CLiterate</label><br>
                <label><input type="radio" name="motherProfession" value="5" title="" <?php if($resultPatientinfo['motherProfession'] == "1"){ echo "checked"; } ?>>Preliterate</label>
            </td>
        </tr>
        <tr>
    ...
    <table class="DiagnosisForm">
        ...
        <tr align="center">
            <td colspan="2" width="50%" height="210px" valign="top">
                Frontal<br>
                <img border="0" src="<?PHP echo 'img/user-pic.jpg'; ?>" alt="Pedigree" width="345" height="210" /><br>
...
<div class="FilesUpload">
    <table class="DiagnosisForm">
        ...
        <tr><td align="center" valign="top" height="500px" width="700px"><img border="0" src="<?PHP echo 'img/user-pic.jpg'; ?>" alt="Pedigree"  width="690" height="500"><br><input type="file" name="pedigree_graphics_other" size="25" title=""></td></tr>
        ...
        <tr><td align="center" valign="top" height="500px" width="700px"><img border="0" src="<?PHP echo 'img/user-pic.jpg'; ?>" alt="Pedigree" width="690" height="500"/><br><input type="file" name="pedigree_graphics9" size="25" title=""></td></tr>
        <tr><td align="center"> Part 6C：Others receipt (1)</td></tr>
        <tr><td align="center" valign="top" height="210px" width="700px"><img border="0" src="<?PHP echo 'img/user-pic.jpg'; ?>" alt="Pedigree" width="690" height="210"/><br><input type="file" name="pedigree_graphics10" size="25" title=""></td></tr>
        <tr><td align="center"> Part 6D：Others receipt (2)</td></tr>
        <tr><td align="center" valign="top" height="210px" width="700px"><img border="0" src="<?PHP echo 'img/user-pic.jpg'; ?>" alt="Pedigree" width="690" height="210" /><br><input type="file" name="pedigree_graphics11" size="25" title=""></td></tr>
        <tr><td align="center"> Part 6E：Others receipt (3)</td></tr>
        <tr><td align="center" valign="top" height="210px" width="700px"><img border="0" src="<?PHP echo 'img/user-pic.jpg'; ?>" alt="Pedigree" width="690" height="210" /><br><input type="file" name="pedigree_graphics12" size="25" title=""></td></tr>
    </table>
</div>
