                  ...
                  <tr>
                    <td width="20%" align="center">
                    	<font size="3" face="Arial">
                    		<select size="1" name="select1" onChange="javascript:window.location = this.options.value">
                        		<option selected>病历管理</option>
                                <?  if($idchk1 = "cn") echo "<option value='searchList.php'>查询 清寒唇腭裂患者补助申请表</option>"; ?>
                                <option value="for-pla-add-china-search.php">新增 清寒唇腭裂患者补助申请表</option>
                        	</select>
                        </font>
                    </td>
                    <td width="20%" align="center">
                    	<font size="3" face="Arial">
                    		<select size="1" name="select2" onChange="javascript:location = this.options.value">
                        		<option  value="main.php" selected>其它功能</option>
