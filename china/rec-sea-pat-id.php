...
<script language="javascript" type="text/javascript">
	<!--
		function checking(){
			if(document.myform.patid.value != ""){
				document.myform.submit();
			}else { 
				alert("Please input Patient's ID.");
				return false;
			}
		}
	//-->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="90%" height="1" style="font-family: Arial; font-size: 12pt; color: #666666; border-collapse: collapse" bordercolor="#111111">
                  <tr>
                    <td width="33%" style="border-top: 1px solid #C0C0C0" height="1" valign="middle">
                        ...
                        <p style="line-height: 200%" align="center">ID of the patient：
                        <?PHP /*
                        <select size="1" name="D1"  onChange="javascript:location.href=this.options.value">
                        <option selected>Please select...</option>
                        <option value="rec-sea-pat-id.php" selected>ID of the patient：</option>
                    ...
                    <td width="80%" style="border-top: 1 solid #C0C0C0" height="1" bgcolor="#F7E3AD"><p style="line-height: 200%"> <font size="2" color="#666666">
                      <input type="text" name="patid" size="20" value="">
                      </font>
                      </td>   
                  </tr>
                  <tr>
