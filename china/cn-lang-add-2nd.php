<?PHP
  ...
  if(!empty($seid) && !empty($sepwd)){
    ...
    $cnPatRec = "SELECT MAX(serialcode) AS serialcode FROM `patient_cn_lang_record` WHERE NCFID='".$resultChinaPatientinfo['NCFID']."' AND branch='3'";
    $qyPatRec = mysql_query($cnPatRec);
    $serCode1 = mysql_fetch_array($qyPatRec);

//echo $serCode1["serialcode"]."<br/>";
...
<FORM Enctype="multipart/form-data" method="post" name="china_medical" action="cn-lang-add-2nd-save.php">
<DIV align=center>
<CENTER>
                        ...
                        <td style="border-style: solid; border-width: 1" colspan="3">
                          ...
                          <p style="line-height: 150%">&nbsp;结构历程
                            ...
                            <font size="3">复韵母简化：<!-- 翻譯 Simplify complex vowel -->
                              <INPUT id="scv_ck" value="" type=checkbox name="scv_ck" />
            ...
            <td style="border-style: solid; border-width: 1" colspan="3">
              <p style="line-height: 150%">&nbsp;
                ...
                <FONT size=3>
                  ...
                  <p style="line-height: 150%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <LABEL><INPUT id="fuptp" value="other" type=radio name="fuptp"></LABEL>
                    其他：
                  ...
                  <td style="border-style: solid; border-width: 1" width="536" valign="top">
                    <FONT size=3>
                      ...
                      <p style="line-height: 150%">&nbsp;&nbsp;医疗费用总计：人民币 
                        <input id="tmcost" maxLength="20" size="5" name="tmcost" value="" /> 元
                      </p>
                      <p style="line-height: 150%">&nbsp;&nbsp;1.申请NCF补助：<br>&nbsp;&nbsp; 
                        <LABEL>
                          <INPUT id="npy_ck" value="1" type=checkbox name="npy_ck"> 鼻咽镜检查费
                        </LABEL>
                        <input id="npy" maxLength="20" size="2" name="npy" value="">元&nbsp; 
                        <LABEL>
                          <INPUT id="lat_ck" value="1" type=checkbox name="lat_ck"> 语言评估费
                        </LABEL>
                          <input id="lat" maxLength="20" size="2" name="lat" value="">元&nbsp; 
                        <LABEL>
                          <INPUT id="spty_ck" value="1" type=checkbox name="spty_ck" /> 语言治疗
                        </LABEL>
                        <input id="spty" maxLength="20" size="2" name="spty" value="" />元<br>&nbsp;&nbsp;&nbsp; 
                        共计人民币
                        <input id="totalRMB" maxLength="20" size="5" name="totalRMB" value="" /> 元，占医疗费用总金额
                        <input id="tRMBps" maxLength="20" size="2" name="tRMBps" value="" /> ％
                      </p>
                      <p style="line-height: 150%">&nbsp; 2.案家自付：人民币
                        <input id="Deductible" maxLength="20" size="5" name="Deductible" value="" /> 元，占医疗费用总金额
                        <input id="ddps" maxLength="40" size="2" name="ddps" value="" /> ％
                      </p>
                    </td>
                    <td style="border-style: solid; border-width: 1" valign="top">
                      <FONT size=3>
                        ...
                        <p style="line-height: 150%">&nbsp;&nbsp; 1.NCF补助：人民币
                          <input id="ncftsRMB" maxLength="20" size="3" name="ncftsRMB" value=""> 元
                        </p>
                        <p style="line-height: 150%">&nbsp;&nbsp; 2.案家自付：人民币
                          <input id="selfpay" maxLength="20" size="3" name="selfpay" value=""> 元
                        </p>
