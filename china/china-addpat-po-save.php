...
$descriptionCaseFamily = $_POST["descriptionCaseFamily"];
	...
	for ($i=1; $i<6; $i++) {
		...
		//echo $chinapatient_insert."<br/><br/>".$chinapatientrecord_insert."<br/><br/>".$CNPat_insert;
