...
//更新---病患基本資料
$chinapatient_insert = "UPDATE `patient-china` SET `school` = '".$school."', 
`caseYear` =  '".$caseYear."',
`caseMonth` =  '".$caseMonth."',
`caseDay` =  '".$caseDay."',
...
`spty` , `totalRMB` , `tRMBps` , `Deductible` , `ddps` , `ncfts_ck` , `ncftsRMB` , `selfpay` , `tcost` , `totalNCF` , `pedigree_graphics_other1` , `pedigree_graphics_other2` , `pedigree_graphics_other3` , `pedigree_graphics_other4` , `pedigree_graphics_other5` , `pedigree_graphics_other6` , `pedigree_graphics_other7` , `pedigree_graphics_other8` , `pedigree_graphics_other9` , `pedigree_graphics_other10` , 
`PGO1` , `PGO2` , `PGO3` , `PGO4` , `PGO5` , `PGO6` , `PGO7` , `PGO8` , `PGO9` , `PGO10` , `remark` )
VALUES (
...
'".$Intelligibility."' , '".$VPI."' , '".$RecF."' , '".$RecHP."' , '".$RecST."' , '".$RecNPS."' , '".$Other_ER."' , '".$TTPN."' , '".$sht_month."' , '".$sht_day."' , 
'".$pdmc."' , '".$astp."' , '".$tmf."' , '".$stee."' , '".$fuptp."' , '".$fuptp_oth."', '".$fuptp_txt."', '".$mlss."' , '".$tmcost."' , '".$npy_ck."' , '".$npy."' , '".$lat_ck."' , '".$lat."' , '".$spty_ck."' , 
'".$spty."' , '".$totalRMB."' , '".$tRMBps."' , '".$Deductible."' , '".$ddps."' , '".$ncfts_ck."' , '".$ncftsRMB."' , '".$selfpay."' , '".$tcost."' , '".$totalNCF."' , '".$pedigree_other[1]."' , '".$pedigree_other[2]."' , '".$pedigree_other[3]."' , '".$pedigree_other[4]."' , '".$pedigree_other[5]."' , '".$pedigree_other[6]."' , '".$pedigree_other[7]."' , '".$pedigree_other[8]."' , '".$pedigree_other[9]."' , '".$pedigree_other[10]."' , 
'".$PGO[1]."' , '".$PGO[2]."' , '".$PGO[3]."' , '".$PGO[4]."' , '".$PGO[5]."' , '".$PGO[6]."' , '".$PGO[7]."' , '".$PGO[8]."' , '".$PGO[9]."' , '".$PGO[10]."' , '".$remark."')";

$query_chinapatientrecord = mysql_query($cn_lang_recode_ins); 
...
$query_CNPat = mysql_query($CNPat_insert);	
