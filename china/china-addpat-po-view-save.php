...
/*		
		$CNPat_sql = "UPDATE `patient-china` SET `school` = '".$school."', 
		`caseYear` =  '".$caseYear."',
`caseMonth` =  '".$caseMonth."',
`caseDay` =  '".$caseDay."',
...
WHERE `NCFID` = '".$NCFID."' LIMIT 1";
		...
		$chinapatient_sql = "UPDATE `patient-china-record` SET `school` = '".$school."', 
`caseYear` =  '".$caseYear."',
`caseMonth` =  '".$caseMonth."',
`caseDay` =  '".$caseDay."',
`surgeryDrName` =  '".$surgeryDrName."',
...
WHERE `NCFID` = '".$NCFID."' LIMIT 1";
		...
		//$chinapatientrecord_sql = "UPDATE `patientrecord-china` SET `branch` = '".$branch."', `serialcode` = '".$serialcode."' , `NCFID` = '".$NCFID."' , `NCFMedicalNum` = '".$NCFMedicalNum."' , `patientName` = '".$patientName."' , `BIHosTimeYear` = '".$BIHosTimeYear."' , `BIHosTimeMonth` = '".$BIHosTimeMonth."' , `BIHosTimeDay` = '".$BIHosTimeDay."' , `surgeryTimeYear` = '".$surgeryTimeYear."' , `surgeryTimeMonth` = '".$surgeryTimeMonth."' , `surgeryTimeDay` = '".$surgeryTimeDay."' , `LHosTimeYear` = '".$LHosTimeYear."' , `LHosTimeMonth` = '".$LHosTimeMonth."' , `LHosTimeDay` = '".$LHosTimeDay."' , `Anesthesia` = '".$Anesthesia."' , `surgeon` = '".$surgeon."' , `anesthesiologist` = '".$anesthesiologist."' , `surgeryType` = '".$surgeryType."' , `surgeryTypeOther_text` = '".$surgeryTypeOther_text."' , `repairTypeUnilateralcleftlip` = '".$repairTypeUnilateralcleftlip."' , `repairTypeUnilateralcleftlip_text` = '".$repairTypeUnilateralcleftlip_text."', `repairTypeBilateralcleftlip` = '".$repairTypeBilateralcleftlip."', `repairTypeBilateralcleftlip_text` = '".$repairTypeBilateralcleftlip_text."', `repairTypeCleftpalate` = '".$repairTypeCleftpalate."', `repairTypeCleftpalate_text` = '".$repairTypeCleftpalate_text."', `BoneGraft` = '".$BoneGraft."', `beforeSurgeryYear` = '".$beforeSurgeryYear."', `beforeSurgeryMonth` = '".$beforeSurgeryMonth."', `beforeSurgeryDay` = '".$beforeSurgeryDay."', `pedigree_graphics1` = '".$pedigree_img[1]."', `afterSurgeryYear` = '".$afterSurgeryYear."', `afterSurgeryMonth` = '".$afterSurgeryMonth."', `afterSurgeryDay` = '".$afterSurgeryDay."', `pedigree_graphics2` = '".$pedigree_img[2]."', `usageofSocialResources` = '".$usageofSocialResources."', `smileTrain` = '".$smileTrain."', `MSitem` = '".$MSitem."', `MSOther` = '".$MSOther."', `MSOther_text` = '".$MSOther_text."', `LAunit` = '".$LAunit."', `LAitem` = '".$LAitem."', `OAunit` = '".$OAunit."', `OAitem` = '".$OAitem."', `h2hdistance` = '".$h2hdistance."', `subsidiesforMedicalExpenses` = '".$subsidiesforMedicalExpenses."', `TotalSFME` = '".$TotalSFME."', `NCFAllowance` = '".$NCFAllowance."', `NCFProportion` = '".$NCFProportion."', `PatientPay` = '".$PatientPay."',`PatientProportion` = '".$PatientProportion."', `transportationSubsidies` = '".$transportationSubsidies."', `NCFSOT` = '".$NCFSOT."', `PatientSOT` = '".$PatientSOT."', `NCFTotalSubsidies` = '".$NCFTotalSubsidies."', `remark` = '".$remark."', `hospitalname` = '".$hospitalname."', `pedigree_graphics_other` = '".$pedigree_graphics_other."', `DrID` = '".$DrID."' WHERE `NCFMedicalNum` = '".$resultChinaPatientRecord['NCFMedicalNum']."' LIMIT 1";	  
...
//		echo $CNPat_sql."<br/><br/>".$chinapatient_sql."<br/><br/>".$chinapatientrecord_sql;
