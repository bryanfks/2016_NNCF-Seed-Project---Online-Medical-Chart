          ...
          <TD bgColor=#fff3de width="100%" align=middle>
            ...
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%" id="table13">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-style: solid; border-width: 2" height="1">
                  <tr>
                    <td width="100%" align="center"><font size="3" face="Arial"><?PHP include("/home/customer/seed-nncf.org/www/top.php"); ?></font></td>
                  </tr>
                  <tr>
                    <td width="100%" align="center"><font size="3" face="Arial"><?PHP include("/home/customer/seed-nncf.org/www/select.php"); ?></font></td>
                  </tr>
                </table>
          ...
          &nbsp;<DIV align=center>
            ...
            size=3>
              ...
              <p style="line-height: 150%"><FONT size=3>&nbsp;父亲年龄</FONT></TD>
                            ...
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=115 rowspan="2">
              <p style="line-height: 150%"><FONT size=3>&nbsp;<INPUT id="fatherAge" maxLength=3 size=4 name="fatherAge" value=""> 岁</FONT></TD>
                            <TD
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=44 rowspan="2">
              <p style="line-height: 150%"><FONT size=3>&nbsp;职业</FONT></TD>
                            ...
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=198 rowspan="2">
              <p style="line-height: 150%"><FONT size=3>&nbsp;<INPUT id="fatherProfession_main" maxLength=20 name="fatherProfession_main" value=""></FONT></TD>
                            <TD
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=79 rowspan="2">
              <p style="line-height: 150%"><FONT size=3>&nbsp;教育程度</FONT></TD>
                            <TD style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" width=221>
              <p style="line-height: 150%"><FONT size=3><LABEL>&nbsp;<INPUT id="fatherProfession" value="大专以上" type=radio name="fatherProfession" <? if($resultChinaPatientinfo['fatherProfession'] == "大专以上"){ echo "checked"; } ?>>大专以上</LABEL>
              <BR>
              <LABEL>&nbsp;<INPUT id="fatherProfession" value="中学" type=radio name="fatherProfession" <? if($resultChinaPatientinfo['fatherProfession'] == "中学"){ echo "checked"; } ?>>中学(专)</LABEL>
              <BR>
              <LABEL>&nbsp;<INPUT id="fatherProfession" value="小学" type=radio name="fatherProfession" <? if($resultChinaPatientinfo['fatherProfession'] == "小学"){ echo "checked"; } ?>>小学</LABEL></FONT></TD></TR>
                          <TR>
                            <TD
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=221>
              <p style="line-height: 150%">
              <FONT size=3><LABEL>
              <INPUT id="fatherProfession" value="不识字" type=radio name="fatherProfession" <? if($resultChinaPatientinfo['fatherProfession'] == "不识字"){ echo "checked"; } ?>>不识字</LABEL></FONT></TD></TR>
                          <TR>
              ...
              <p style="line-height: 150%"><FONT size=3>&nbsp;母亲年龄</FONT></TD>
                            ...
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=115 rowspan="2">
              <p style="line-height: 150%"><FONT size=3>&nbsp;<INPUT id="motherAge" maxLength=3 size=4 name="motherAge" value=""> 岁</FONT></TD>
                            <TD
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=44 rowspan="2">
              <p style="line-height: 150%"><FONT size=3>&nbsp;职业</FONT></TD>
                            ...
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=198 rowspan="2">
              <p style="line-height: 150%"><FONT size=3>&nbsp;<INPUT id="motherProfession_main" maxLength=20 name="motherProfession_main" value=""></FONT></TD>
                            <TD
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=79 rowspan="2">
              <p style="line-height: 150%"><FONT size=3>&nbsp;教育程度</FONT></TD>
                            <TD style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" width=221>
              <p style="line-height: 150%"><FONT size=3>
              <LABEL>&nbsp;<INPUT id="motherProfession" value="大专以上" type=radio name="motherProfession" <? if($resultChinaPatientinfo['motherProfession'] == "大专以上"){ echo "checked"; } ?>>大专以上</LABEL>
              <BR>
              <LABEL>&nbsp;<INPUT id="motherProfession" value="中学" type=radio name="motherProfession" <? if($resultChinaPatientinfo['motherProfession'] == "中学"){ echo "checked"; } ?>>中学(专)</LABEL>
              <BR>
              <LABEL>&nbsp;<INPUT id="motherProfession" value="小学" type=radio name="motherProfession" <? if($resultChinaPatientinfo['motherProfession'] == "小学"){ echo "checked"; } ?>>小学</LABEL></FONT></TD></TR>
                          <TR>
                            <TD
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=221>
              <p style="line-height: 150%">
              <FONT size=3><LABEL>
              <INPUT id="motherProfession" value="不识字" type=radio name="motherProfession" <? if($resultChinaPatientinfo['motherProfession'] == "不识字"){ echo "checked"; } ?>>不识字</LABEL></FONT></TD></TR>
                          </TBODY></TABLE></DIV>
                        <DIV align=center>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  &nbsp;<div align="center">
          ...
          <tr>
            ...
            <font size="3">
            <p style="line-height: 150%">&nbsp;<input id="surgeryType10" value="M1LNR" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "M1LNR"){ echo "checked"; } ?>>一期单侧唇鼻修复 
            <input id="surgeryType1" value="M1BLANR" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "M1BLANR"){ echo "checked"; } ?>>一期双侧唇鼻修复 
            <input id="surgeryType2" value="M1CPR" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "M1CPR"){ echo "checked"; } ?>>一期颚裂修复 
            <input id="surgeryType3" value="MFHR" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "MFHR"){ echo "checked"; } ?>>廔孔修复</p>
            <p style="line-height: 150%">
            &nbsp;<input id="surgeryType4" value="M2CPR" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "M2CPR"){ echo "checked"; } ?>>二期颚裂(颚咽)修复 
            <input id="surgeryType5" value="MLR" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "MLR"){ echo "checked"; } ?>>唇鼻整形 
            <input id="surgeryType6" value="MAB" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "MAB"){ echo "checked"; } ?>>齿槽植骨 
            <input id="surgeryType7" value="MPF" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "MPF"){ echo "checked"; } ?>>咽瓣修复 
            <input id="surgeryType8" value="MPBR" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "MPBR"){ echo "checked"; } ?>>梨骨瓣修复</p>
            <p style="line-height: 150%">&nbsp;<input id="surgeryType19" value="MOTH" type="radio" name="surgeryType" <? if($resultChinaPatientRecord['surgeryType'] == "MOTH"){ echo "checked"; } ?>>其他：<input id="surgeryTypeOther_text" maxLength="20" name="surgeryTypeOther_text" size="30" value=""></font></td>
