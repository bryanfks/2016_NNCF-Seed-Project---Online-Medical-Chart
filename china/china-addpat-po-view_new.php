<?PHP
  ...
  if(!empty($seid) && !empty($sepwd)){
    ...
    $cnPatRec = "SELECT MAX(serialcode) AS serialcode FROM `patientrecord-china` WHERE NCFID='".$resultChinaPatientinfo['NCFID']."' AND branch='2'";
...
<HTML>
	<HEAD>
      ...
      document.getElementById("fatherAge").value = "<?PHP echo $resultChinaPatientinfo['fatherAge']; ?>";  
...
<FORM enctype="multipart/form-data" method="post" name="china_medical" action="china-addpat-po-view_new_save.php">
<DIV align=center>
<CENTER>
                        ...
                        <TABLE border=0 cellSpacing=1 width="100%">
                          ...
                          <TR> 
                            ...
                            <TD style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" width=592 colSpan=3>
                              <p style="line-height: 150%">
                                <font size="3">
                                  <label>&nbsp;<input id="h2hdistance" type="radio" value="100" name="h2hdistance" <? if($resultChinaPatientinfo['h2hdistance'] == "100"){ echo "checked"; } ?>>少于100公里</label>
                                  <label><input id="h2hdistance" type="radio" value="100-200" name="h2hdistance" <? if($resultChinaPatientinfo['h2hdistance'] == "100-200"){ echo "checked"; } ?>>100-200公里</label>
                                  <label><input id="h2hdistance" type="radio" value="200" name="h2hdistance" <? if($resultChinaPatientinfo['h2hdistance'] == "200"){ echo "checked"; } ?>>大于200公里</label>
                                </font>
                              </p>
                            </TD>
                          </TR>
                      ...
                      <TD>
                        ...
                        <TABLE border=0 cellSpacing=1 width="100%">
                          ...
                          <TR>
                            ...
                            <TD style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" width=290>
                              <p style="line-height: 150%"><FONT size=3>&nbsp;<INPUT id="height" maxLength="10" size="6" name="height" value="" /> 公分</FONT></p>
                            </TD>
                            <TD style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" width=89>
                              <p style="line-height: 150%"><FONT size=3>*体重</FONT></p>
                            </TD>
                            <TD style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" width=203>
                              <p style="line-height: 150%"><FONT size=3>&nbsp;<INPUT id="weight" maxLength="10" size="6" name="weight" value="" /> 公斤</FONT></p>
                            </TD>
                          </TR>
                          </TBODY>
                        </TABLE>
                            ...
                            <TD style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" width=592>
                              ...
                              <P style="line-height: 150%">&nbsp;
                                <FONT size=3>
                                  ...
                                  <LABEL>
                                    <INPUT id="incomplete_main" value="IC" type=radio name="incomplete_main" <? if($resultChinaPatientinfo['incomplete_main'] == "IC"){ echo "checked"; } ?>>
                                  </LABEL>不完全性 (
                                    <LABEL>
                                  ...
                                  － 
                                  <LABEL>
                                    <INPUT id="incomplete_main" value="C" type=radio name="complete_main" <? if($resultChinaPatientinfo['incomplete_main'] == "C"){ echo "checked"; } ?> />
                                  </LABEL> 完全性 (
                    ...
                    <tr>
                      <font size="3">
                        ...
                        <td style="border-style: solid; border-width: 1" width="258">
                          <p style="line-height: 150%"><font size="3">&nbsp;<input id="surgeon" maxLength="4" size="23" name="surgeon"></font></p>
                        </td>
                     </font>
                    </tr>
                    <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          &nbsp;<table border="1" cellspacing="1" width="100%" id="table50">
            ...
            size=3>&nbsp;NCF补助编号：</td>
              ...
              <input id="NCFProportion" maxLength="10" size="6" name="NCFProportion"> 
              %</p>
              <p style="line-height: 150%">&nbsp; 2.案家自付：人民&#24065;
              <input id="PatientPay" maxLength="6" size="3" name="PatientPay" value=""> 元，占&#21307;&#30103;&#36153;用&#24635;金&#39069;
                          <input id="PatientProportion" maxLength="10" size="6" name="PatientProportion" value=""> 
              %</p>
                      </td>
        ...
        <TR>
          <TD height=1 width="100%" align=middle>
            ...
            <FONT color=#999999>： </FONT><FONT face=Arial><FONT color=#999999>Internet&nbsp; Explorer&nbsp; 6.02 (Or Update)&nbsp;/&nbsp; 800 x 600&nbsp; Resolution<BR>Copyright <span lang="zh-tw">©</span>&nbsp;&nbsp;
              ...
              <INPUT value="<?PHP echo $resultChinaPatientinfo['NCFID']; ?>" type=hidden name="NCFID"> 
              <input type="hidden" name="num" value="">
              <INPUT value="2" type=hidden name="branch"> 
              <INPUT value="<?PHP echo $newSerialcode; ?>" type=hidden name="serialcode">
            </FORM></BODY></HTML>
<?PHP
      }else{
