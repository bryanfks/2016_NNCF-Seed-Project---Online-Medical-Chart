<?PHP
  ...
  if(!empty($seid) && !empty($sepwd)){
    ...
    $DrID = $resultChinaPatientinfo["DrID"];
      ...
      <TABLE style="BORDER-BOTTOM: 2px solid; BORDER-LEFT: 2px solid; BORDER-TOP: 2px solid; BORDER-RIGHT: 2px solid" border=0 bgcolor="#FFF3DE" cellSpacing=0 cellPadding=0 width="100%" height=1 id="table12">
        ...
        <TR>
          ...
          &nbsp;<DIV align=center>
              ...
              <INPUT id="gender_male" value="M" type=radio name="gender" <? if(($resultChinaPatientinfo['gender'] == "M") || ($resultChinaPatientinfo['gender'] == "男")){ echo "checked"; } ?>>男</LABEL> <LABEL><INPUT id="gender_female" value="F" type=radio name="gender" <? if(($resultChinaPatientinfo['gender'] == "F") || ($resultChinaPatientinfo['gender'] == "女")){ echo "checked"; } ?>>女</LABEL></FONT></TD></TR>
                          <TR>
                            <TD
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=135>
          ...
          &nbsp;<DIV align=center>
            ...
            size=3>
              ...
              <p style="line-height: 150%"><FONT size=3>*体重</FONT></TD>
                            ...
                            style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid"
                            width=203>
              <p style="line-height: 150%"><FONT size=3>&nbsp;<INPUT id="weight" maxLength="10" size="5" name="weight" value="">
              ...
              <p style="line-height: 150%"><FONT size=3>*主诊断<BR>&nbsp;（医学专有名词）</FONT></TD>
                            ...
                            width=592>
                              ...
                              <P style="line-height: 150%">&nbsp;<FONT size=3><LABEL for=checkbox9>
                              <INPUT id="CleftPalate" value=CP type=checkbox name="CleftPalate" <? if($resultChinaPatientinfo['CleftPalate'] == "CP"){ echo "checked"; } ?>></LABEL>颚裂 － <LABEL for=checkbox11>
                              <INPUT id="complete_main" value="IC" type=radio name="complete_main"<? if($resultChinaPatientinfo['complete_main'] == "IC"){ echo "checked"; } ?>></LABEL>不完全性 (
                              <LABEL for=checkbox11>
                                <INPUT id="incomplete" value="SCC" type=radio name="incomplete" <? if($resultChinaPatientinfo['incomplete'] == "SCC"){ echo "checked"; } ?>></LABEL>粘膜下裂
          ...
          &nbsp;<DIV align=center>
            ...
            size=3>
                                  ...
                                  <TD style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" width=221>
                                    <p style="line-height: 150%">
                                      <FONT size=3>
                                        ...
                                        <LABEL>&nbsp;<INPUT id="Cleft_lip_and_palate_surgery" value="不识字" type=radio name="fatherProfession" <? if($resultChinaPatientinfo['fatherProfession'] == "不识字"){ echo "checked"; } ?>>不识字</LABEL>
                                      </FONT>
                                    </p>
                                  </TD>
                                </TR>
              ...
              <p style="line-height: 150%"><FONT size=3><LABEL for=fixedExpenditure1>&nbsp;1.
                              <INPUT id="fixedExpenditure1" maxLength=30 size=30 name="fixedExpenditure1" value=""></LABEL>
              <BR>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <FONT size=3>
              ...
              <input id="PatientPay" maxLength="10" size="5" name="PatientPay"> 元，占&#21307;&#30103;&#36153;用&#24635;金&#39069;
                          <input id="PatientProportion" maxLength="10" size="3" name="PatientProportion" value="">%</p>
                      </td>
    ...
    <input type="hidden" name="branchserialcode" value="<?php echo $resultChinaPatientRecord['NCFMedicalNum'];  ?>">
