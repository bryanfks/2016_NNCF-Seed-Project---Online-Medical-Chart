  ...
  <tr>
          ...
          <tr>
            <td width="100%" align="center" bgcolor="#F7EBC6" valign="top">
                  ...
                  <tr>
                    <td width="33%" style="border-top: 1px solid #C0C0C0" height="1" valign="middle">
                      <form method="POST" action="--WEBBOT-SELF--">
                        <!--webbot bot="SaveResults" u-file="fpweb:///_private/form_results.csv" s-format="TEXT/CSV" s-label-fields="TRUE" --><p style="line-height: 200%" align="center">
                        <select size="1" name="D1">
                        <option selected value="Please select...">Please 
                        select...</option>
                        <option>ID of the patient：</option>
                        <option>Name of the patient：</option>
                        <option>Nationality of the patient：</option>
                        <option>ID of the editor：</option>
                        </select></p>
                      </form>
                    </td>              
                    <td width="67%" style="border-top: 1 solid #C0C0C0" height="1" bgcolor="#F7E3AD">
                      ...
                      <p style="line-height: 200%"><font size="2" color="#666666">&nbsp;</font>
                      <p style="line-height: 200%"><font color="#666666" size="2">&nbsp;</font></td>   
                  </tr>
                  <tr>
                    <td style="border-top: 1 solid #C0C0C0" height="4" colspan="2">
              ...
              <font size="2">
              <input type="button" value="SEARCH" name="search" onClick="a()"></font><p align="left" style="line-height: 200%; margin-left: 10; margin-right: 10">
              　</td>
  </tr>
                    </table>
                  </div>
