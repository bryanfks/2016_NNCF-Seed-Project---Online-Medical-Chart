          ...
          <tr>
            <td width="100%" align="center" bgcolor="#F7EBC6" valign="top">
                ...
                <table border="1" cellpadding="0" cellspacing="0" width="90%">
					<tr>
						<td width="16%" align="center" height="19" valign="middle">
                        	<p style="line-height: 150%">查无符合资料！</p>
                            <p style="line-height: 150%">请按下“新增”直接新增补助申请表或是按下“取消”重新查询。</p>
                        </td>
                  </tr>
                </table>
                </center>
              ...
              <p align="center" style="line-height: 200%; margin-left: 10; margin-right: 10">
              	<input type="button" name="addNewRecord" value="新增" onClick="return addData()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="button" name="cancelSearchData" value="取消" onClick="return cancelSearch()">
              </p>
              <p>
              </p>
              　</td>
