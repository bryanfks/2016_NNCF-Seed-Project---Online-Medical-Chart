                ...
                <table border="1" cellspacing="1" width="90%">
                  ...
                  <tr>
                    ...
                    <?PHP 
						...
						$sel_pat_rec = "SELECT `editor` FROM `patientmr` WHERE patientid=\"".$rec_num."\" AND branch=\"".$rec_branch."\" AND serialcode=\"".$rec_serialcode."\"";
						...
						//echo "<p>value: ".$res_chkID."</p>";
						
						if(($res_chkID == 1) || ($res_chkID == "1")) { 			//   判斷國內醫師是否為直屬學長
					?>
                    ...
                    <?PHP } else if(($res_chkID_value["condition"] != "5") && (($res_chkID != 0) || ($res_chkID != "0") || (!empty($res_chkID)))) { ?>
						<input type="button" value="SAVE" name="SendData" onClick="return saveData('save')">　　　　　<input type="button" value="SUBMIT" name="SendData" onClick="return saveData('submit')">
					<?	} ?>
                        </font><p align="right">
                    </font></td>   
