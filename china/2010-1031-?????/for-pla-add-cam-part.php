<?PHP
	...
	if(!empty($seid) && !empty($sepwd)){
		...
		if($record_nums){
			...
			//$serialcode_num = substr($record_nums, 9, 10);
              ...
              <font color="#666666">&nbsp;Diagnosis：</font></p>
                  ...
                  <tr on>
                      ...
                      Travel allowance<font size="2">： </font> <input type="text" name="tra_allowper" size="1" value=""><font size="2"> person *  
                          ...
                          <option value="0" <?PHP if($res_PatientRecord["tra_allowdist"] == "0"){ echo "SELECTED"; }?>>Please select...</option>
                          <option value="4" <?PHP if($res_PatientRecord["tra_allowdist"] == "4"){ echo "SELECTED"; }?>>less than 100km (4 USD/per person)</option>
                          <option value="8" <?PHP if($res_PatientRecord["tra_allowdist"] == "8"){ echo "SELECTED"; }?>>less than 200km (8 USD/per person)</option>
                          <option value="10" <?PHP if($res_PatientRecord["tra_allowdist"] == "10"){ echo "SELECTED"; }?>>more than 200km (10 USD/per person)</option>
				  ...
				  */ ?>
                  ...
                  <tr>
                    ...
                    <font size="3">
                    <?PHP 
						if(($res_PatientRecord["editor"] == $seid) || ($res_PatientRecord["editor"] == "")) {  ?>
