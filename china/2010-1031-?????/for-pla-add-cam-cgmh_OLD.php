                        ...
                        <div align="left">
                          <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                              <td width="16%">&nbsp;&nbsp;&nbsp;&nbsp;</td>
                              <?PHP 
							  		//echo "<a id='NCF_Dep_Part' onClick='return checkPartner2()' href='#'></a>";
									//echo "<input type='hidden' id='partner_value' name='partner_value' value='".$pat_id_1."'> "; ?>
                              <? if($res_Memberdata['authority']  == 'p'){ ?>
                              	<td width="1%"></td>
                              	<td width="21%"><img border="0" src="images/label-22.gif" width="160" height="40"></td>
                              <?  } elseif ($res_Memberdata['authority']  == 'c') { ?>
                              	<td width="8%"></td>
                              	<td width="21%"><img border="0" src="images/label-23.gif" width="160" height="40"></td>
              ...
              &nbsp;<div align="center">
                ...
                <table border="1" cellspacing="1" width="90%">
                  ...
                  <tr>
                    <td width="100%">
                              <p align="left" style="margin-left: 10; margin-right: 10">
                      <font color="#666666">&nbsp;<input type="checkbox" name="ncf_livallow" value="" <?PHP if($res_PatientRecord["ncf_livallow"] == "ON"){ echo "CHECKED"; } ?>>
                      A. Living allowance： <?PHP echo $res_PatientRecord["ncf_livallowday"]; ?> day(s) * 2 USD per day</font></p>    
                              <p align="left" style="margin-left: 10; margin-right: 10">
                      <font color="#666666">&nbsp;<input type="checkbox" name="ncf_traallow" value="" <?PHP if($res_PatientRecord["ncf_traallow"] == "ON"){ echo "CHECKED"; } ?>>B.    
                      Travel allowance<font size="2">： </font> <?PHP echo $res_PatientRecord["ncf_tolamont"]; ?><font size="2"> person *   
                              ...
                              <p align="left" style="margin-left: 10; margin-right: 10">
                      <font color="#666666">&nbsp;<input type="checkbox" name="ncf_surallow" value="" <?PHP if($res_PatientRecord["ncf_surallow"] == "ON"){ echo "CHECKED"; } ?>>C.    
