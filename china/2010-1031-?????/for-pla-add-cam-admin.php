...
//echo "serialcode_result: ".$serialcode_result."<br /> Serial Code: ".$serialcode."<br />";
...
<script language="javascript">
	<!--
		function previewData(){
			...
			document.ppls_form.ncf_livallowday.value = "<?PHP echo $res_PatientRecord["ncf_livallowday"]; ?>";
			document.ppls_form.ncf_traallowper.value = "<?PHP echo $res_PatientRecord["ncf_traallowper"]; ?>";
			document.ppls_form.ncf_traallowdist.value = "<?PHP echo $res_PatientRecord["ncf_traallowdist"]; ?>";
			document.ppls_form.ncf_tolamont.value = "<?PHP echo $res_PatientRecord["ncf_tolamont"]; ?>";
		...
		function saveData(opt){
			if(opt == "save"){
				...
				if (document.ppls_form.liv_allow.checked) {
					document.ppls_form.liv_allows.value = "ON";
				} else {
					document.ppls_form.liv_allows.value = "";
				}
				if (document.ppls_form.tra_allow.checked) {
					document.ppls_form.tra_allows.value = "ON";
				} else {
					document.ppls_form.tra_allows.value = "";
				}
				if (document.ppls_form.ncf_livallow.checked) {
					document.ppls_form.ncf_livallows.value = "ON";
				} else {
					document.ppls_form.ncf_livallows.value = "";
				}
				if (document.ppls_form.ncf_traallow.checked){
					document.ppls_form.ncf_traallows.value = "ON";
				} else {
					document.ppls_form.ncf_traallows.value = "";
				}
				if (document.ppls_form.ncf_surallow.checked) {
					document.ppls_form.ncf_surallows.value = "ON";
				} else {
					document.ppls_form.ncf_surallows.value = "";
				}
				document.ppls_form.condition.value = "3";		/* 原為1，改為3*/
				document.ppls_form.action = "for-pla-sav-cam-admin.php";
				...
				document.ppls_form.action = "for-pla-sub-cam-admin.php";
				document.ppls_form.submit();
				return true;
			}
		}
          ...
          <tr>
            <td width="103%" align="center" bgcolor="#F7EBC6" valign="top">
              ...
              <font color="#666666">&nbsp;Name of the hospital： 
              		<select size="1" name="hospital" onChange="input_Hospital()">   
                        ...
                        <OPTION value="OTHER" <? if(($res_PatientRecord["hospital"] != "National Pediatric Hospital") && ($res_PatientRecord["hospital"] != "Affiliated Stomatological Hospital of Nanjing Medical University") && ($res_PatientRecord["hospital"] != "People`s Hospital of Hulunbeier,Southern Mongolian") && ($res_PatientRecord["hospital"] != "Shenzhen Second Hospital") && ($res_PatientRecord["hospital"] != "The Affiliated Hospital of Medical College,Qingdao University") && ($res_PatientRecord["hospital"] != "The 2nd Affiliated Hospital of Shantou University Medical College") && ($res_PatientRecord["hospital"] != "The First Hospital of Shanxi Medical University") && ($res_PatientRecord["hospital"] != "West China College of Stomatology Sichuan University") && ($res_PatientRecord["hospital"] != "Cipto Mangunkusumo Hospital") && ($res_PatientRecord["hospital"] != "Our Lady of Peace Hospital") && ($res_PatientRecord["hospital"] != "St. Elizabeth Hospital") && ($res_PatientRecord["hospital"] != "Ho Chi Minh Health Department Odorto Mazillo Hospital") && ($res_PatientRecord["hospital"] != "")){ echo "SELECTED"; }?>>Other</OPTION>
                    </select> 
                    <input type="text" name="hospitals" size="20" value="" disabled></font></p>   
                              <p align="left" style="margin-left: 10; margin-right: 10">
              ...
              <font color="#666666">&nbsp;Diagnosis：</font></p>
                          ...
                          <option value="Right incomplete" <?PHP if($res_PatientRecord["lip"] == "Right incomplete"){ echo "SELECTED"; }?>>Right incomplete</option>
                                  ...
                                  <td width="25%">
                                  <p align="left" style="margin-left: 10; margin-right: 10">
                                  <font color="#666666"><select size="1" name="alveolus">
                  ...
                  <tr>
                      ...
                      <font color="#666666">&nbsp;<b>Financial Assistance：</b></font></p>   
                              <p align="left" style="margin-left: 10; margin-right: 10">
                      <font color="#666666">&nbsp;<input type="checkbox" name="liv_allow" value="ON" <?PHP if($res_PatientRecord["liv_allow"] == "ON"){ echo "CHECKED"; } else { echo "";} ?>> A. Living allowance： <select size="1" name="liv_allowday">   
                      	  <option value="0" <?PHP if($res_PatientRecord["liv_allowday"] == "0" || ""){ echo "SELECTED"; }?>>0</option>
                          <option value="1" <?PHP if($res_PatientRecord["liv_allowday"] == "1"){ echo "SELECTED"; }?>>1</option>
                          <option value="2" <?PHP if($res_PatientRecord["liv_allowday"] == "2"){ echo "SELECTED"; }?>>2</option>
                          <option value="3" <?PHP if($res_PatientRecord["liv_allowday"] == "3"){ echo "SELECTED"; }?>>3</option>
                        <option value="4" <?PHP if($res_PatientRecord["liv_allowday"] == "4"){ echo "SELECTED"; }?>>4</option>
                        <option value="5" <?PHP if($res_PatientRecord["liv_allowday"] == "5"){ echo "SELECTED"; }?>>5</option>
                        <option value="6" <?PHP if($res_PatientRecord["liv_allowday"] == "6"){ echo "SELECTED"; }?>>6</option>
                        <option value="7" <?PHP if($res_PatientRecord["liv_allowday"] == "7"){ echo "SELECTED"; }?>>7</option>
                        <option value="8" <?PHP if($res_PatientRecord["liv_allowday"] == "8"){ echo "SELECTED"; }?>>8</option>
                      ...
                      Travel allowance<font size="2">： </font> <input type="text" name="tra_allowper" size="1" value=""><font size="2"> person *  
                      </font> <select size="1" name="tra_allowdist"> 
                          <option value="0" <?PHP if($res_PatientRecord["tra_allowdist"] == "0"){ echo "selected='selected'"; }?>>Please select...</option>
                          <option value="4" <?PHP if($res_PatientRecord["tra_allowdist"] == "4"){ echo "selected='selected'"; }?>>less than 100km (4 USD/per person)</option>
                          <option value="8" <?PHP if($res_PatientRecord["tra_allowdist"] == "8"){ echo "selected='selected'"; }?>>less than 200km (8 USD/per person)</option>
                          <option value="10" <?PHP if($res_PatientRecord["tra_allowdist"] == "10"){ echo "selected='selected'"; }?>>more than 200km (10 USD/per person)</option>
              ...
              &nbsp;<div align="center">
                ...
                <table border="1" cellspacing="1" width="90%">
                  ...
                  <tr>
                    ...
                    <font color="#666666">&nbsp;This operation result is：</font></p>    
                    <p align="left" style="margin-left: 10; margin-right: 10">
                    <font color="#666666">&nbsp;　<input type="radio" name="op_results"  value="Excellent" <?PHP if($res_PatientRecord["op_results"] == "Excellent"){ echo "CHECKED"; } else{ echo ""; } ?>>Excellent　　<input type="radio" name="op_results" value="Good" <?PHP if($res_PatientRecord["op_results"] == "Good"){ echo "CHECKED"; } else{ echo ""; } ?>>Good　　<input type="radio" name="op_results" value="Average" <?PHP if($res_PatientRecord["op_results"] == "Average"){ echo "CHECKED"; } else{ echo ""; } ?>>Average　　<input type="radio" name="op_results" value="Poor" <?PHP if($res_PatientRecord["op_results"] == "Poor"){ echo "CHECKED"; } else{ echo ""; } ?>>Poor</font></p> 
                    <p align="left" style="margin-left: 10; margin-right: 10">
              ...
              &nbsp;<div align="center">
                ...
                <table border="1" cellspacing="1" width="90%">
                  ...
                  <tr>
                    <td width="100%">
                    <p align="left" style="margin-left: 10; margin-right: 10">
                    <font color="#666666">&nbsp;<input type="checkbox" name="ncf_livallow" value="ON" <?PHP if($res_PatientRecord["ncf_livallow"] == "ON"){ echo "CHECKED"; } else if(($res_PatientRecord["ncf_livallow"] == "") || ($res_PatientRecord["ncf_livallow"] == "false")){ echo "";} ?>>A.    
                      Living allowance： <select size="1" name="ncf_livallowday">    
                        <option value="0" <?PHP if((empty($res_PatientRecord["ncf_livallowday"])) || ($res_PatientRecord["ncf_livallowday"] == "0")){ echo "selected='selected'"; } ?>>0</option>
                          <option value="1" <?PHP if($res_PatientRecord["ncf_livallowday"] == "1"){ echo "selected='selected'"; }?>>1</option>
                          <option value="2" <?PHP if($res_PatientRecord["ncf_livallowday"] == "2"){ echo "selected='selected'"; }?>>2</option>
                          <option value="3" <?PHP if($res_PatientRecord["ncf_livallowday"] == "3"){ echo "selected='selected'"; }?>>3</option>
                        <option value="4" <?PHP if($res_PatientRecord["ncf_livallowday"] == "4"){ echo "selected='selected'"; }?>>4</option>
                        <option value="5" <?PHP if($res_PatientRecord["ncf_livallowday"] == "5"){ echo "selected='selected'"; }?>>5</option>
                        <option value="6" <?PHP if($res_PatientRecord["ncf_livallowday"] == "6"){ echo "selected='selected'"; }?>>6</option>
                        <option value="7" <?PHP if($res_PatientRecord["ncf_livallowday"] == "7"){ echo "selected='selected'"; }?>>7</option>
                        <option value="8" <?PHP if($res_PatientRecord["ncf_livallowday"] == "8"){ echo "selected='selected'"; }?>>8</option>
                      </select> day(s) * 2 USD per day</font></p>    
                              <p align="left" style="margin-left: 10; margin-right: 10">
                      <font color="#666666">&nbsp;<input type="checkbox" name="ncf_traallow" value="ON" <?PHP if(($res_PatientRecord["ncf_traallow"] == "") || ($res_PatientRecord["ncf_traallow"] == "false")){ echo ""; } else if ($res_PatientRecord["ncf_traallow"] == "ON"){ echo "CHECKED"; } ?>>B.    
                      Travel allowance<font size="2">： </font> <input type="text" name="ncf_traallowper" size="1" value=""><font size="2"> person *   
                      </font> <select size="1" name="ncf_traallowdist"> 
                      	  <option value="0" <?PHP if((empty($res_PatientRecord["ncf_traallowdist"])) || ($res_PatientRecord["ncf_traallowdist"] == "0")){ echo "selected='selected'"; } ?>>Please select...</option>
                          <option value="4" <?PHP if($res_PatientRecord["ncf_traallowdist"] == "4"){ echo "selected='selected'"; }?>>less than 100km (4 USD/per person)</option>
                          <option value="8" <?PHP if($res_PatientRecord["ncf_traallowdist"] == "8"){ echo "selected='selected'"; }?>>less than 200km (8 USD/per person)</option>
                          <option value="10" <?PHP if($res_PatientRecord["ncf_traallowdist"] == "10"){ echo "selected='selected'"; }?>>more than 200km (10 USD/per person)</option>
                        </select>
                        <font size="2"> distance</font></font></p> 
                              <p align="left" style="margin-left: 10; margin-right: 10">
                      <font color="#666666">&nbsp;<input type="checkbox" name="ncf_surallow" value="ON" <?PHP  if(($res_PatientRecord["ncf_surallow"] == "") || ($res_PatientRecord["ncf_surallow"] == "false")){ echo ""; } else if ($res_PatientRecord["ncf_surallow"] == "ON"){ echo "CHECKED"; } ?>>C.    
                      Surgery allowance： 20 USD per patient</font></p>    
                              <p align="left" style="margin-left: 10; margin-right: 10">
              ...
              <font color="#666666">Note：</font></p>          
                  ...
                  <tr>
                    ...
                    <font size="3">
                    <?PHP  //if(($res_PatientRecord["editor"] == $seid) || ($res_PatientRecord["editor"] == "")) {  ?>
            ...
            <tr>
              <td width="100%" height="1" align="center">
				...
				<input type="hidden" name="liv_allows" value="">
                <input type="hidden" name="tra_allows" value="">
                <input type="hidden" name="sur_allows" value="">
				<input type="hidden" name="ncf_livallows" value="">
                <input type="hidden" name="ncf_traallows" value="">
                <input type="hidden" name="ncf_surallows" value="">
</form>
</body>
