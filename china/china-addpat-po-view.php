...
<HTML>
	<HEAD>
      ...
      function saveData(opt){
          //alert (document.diagnosis_unilateral_cleft_lip_2.value);
          //alert(opt);
          if(opt == "save"){
            // 警示未填写必要输入项资料
        ...
        function printRecord() {
            ...
            n = "<?PHP echo $ncfmn; ?>";
            window.open('../china/china-addpat-po-view-print.php?cpi='+cpi+'&n='+n,'',config=',,toolbar=no');
        }
    </SCRIPT>
</HEAD>
<BODY topMargin=2 onLoad="inputData()">
<FORM enctype="multipart/form-data" method="post" name="china_medical" action="china-addpat-po-view-save.php">
<DIV align=center>
<CENTER>
              ...
              <TR>
                <TD align=left>
                  ...
                  <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" bgColor=#ff9966 height=50 id="table14">
                    <TBODY>
                      <tr bgcolor="#FFFFFF">
                        <td align="center"><font size="2" face="Arial"><?PHP include("top2.php"); ?></font></td>
                      </tr>
                      <tr bgcolor="#C0C0C0">
                        <td align="center"><font size="2" face="Arial"><?PHP include("select2.php"); ?></font></td>
                      </tr>
                    <TR>
                      <TD>
