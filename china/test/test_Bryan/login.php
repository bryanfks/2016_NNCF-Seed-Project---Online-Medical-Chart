...
<?PHP
	...
	if($pgValue == 1){               
		$chkId = "SELECT * FROM member WHERE id='".$id."' AND pwd='".$pwd."'";               
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="750" background="images/login-3.jpg" height="400">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="377" bgcolor="#FFFFFF" height="195">
                      <tr>
                        <td bgcolor="#FFCF63" align="center" width="375" height="30">
                          <p align="center" style="line-height: 150%"><i><font color="#0033CC" face="Arial" size="5">Patient                                
                          Record Online<br>    
                      ...
                      <tr>
                        <td align="center" style="border: 1 solid #FFCF63" width="375" height="165">
                          ...
                          <p align="center" style="line-height: 100%"><font face="Arial"><font size="3">Password</font></font><font size="3"><font color="#666666">：</font><input type="password" name="pwd" size="10"></font></p>
                        </center>
                          <p align="center" style="line-height: 100%"><font size="3">　　　　　<input type="submit" value="LOGIN" name="loginbutton">　　　<a href="mailto:seed-nncf@nncf.org"><font face="Arial"><font color="#0066CC">Forget     
                          ID or password ?</font>   
                          </font>
                          </a>  
                          </font>
    ...
    <center>
          <p align="center" style="line-height: 100%"></p>     
          <p align="center" style="line-height: 100%"><i><font size="3"><font face="Arial" color="#999999">The&nbsp; Web&nbsp; Best&nbsp;                                     
