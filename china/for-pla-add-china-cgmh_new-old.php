                ...
                <div align="center">
                  ...
                  <table border="0" cellspacing="1" width="780">
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1"><label><font size="3">&nbsp;<input id="Anesthesia0" type="radio" value="全身麻醉" name="Anesthesia" <?php if($resultChinaPatientRecord['Anesthesia'] =="全身麻醉"){echo "selected";}  ?>>全身麻醉   

                          <input id="Anesthesia1" type="radio" value="局部麻醉" name="Anesthesia" <?php if($resultChinaPatientRecord['Anesthesia'] =="局部麻醉"){echo "selected";}  ?>>局部麻醉</font></label></td>
				...
				<td>
					<p align="center">
                		<font size="3">
                        	...
                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        	<input id="cancelAdd" onClick="return saveData('cancelAdd')" type="button" value="取消" name="cancelAdd">
                        </font>
               		</p>
               </td>
			</tr>
