        ...
        <tr>
            <td style="vertical-align:middle;" class="TitleBar">
                <select size="1" name="hospital" title="">
                    <option value="" <?php if($resultPatientinfo['school'] == ""){ echo "selected"; } ?>>Please select...</option>
                    <option value="OMFH" <?php if($resultPatientinfo['school'] == "OMFH"){ echo "selected"; } ?>>Odonto Maxillo Facial Hospital</option>
                </select>
    ...
    <table class="DiagnosisForm">
        ...
        <tr align="center">
            <td colspan="2" width="50%" height="210px" valign="top">
                Frontal<br>
                <img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics1'])){ echo $resultPatientRecord['pedigree_graphics1']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="345" height="210" />
            </td>
            <td colspan="2" width="50" height="210px" valign="top">
                Side<br>
                <img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics4'])){ echo $resultPatientRecord['pedigree_graphics4']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="345" height="210" />
            </td>
        </tr>
        <tr align="center">
            <td colspan="2" width="375px" height="210px" valign="top">
                Shape of nose’s hole<br>
                <img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics3'])){ echo $resultPatientRecord['pedigree_graphics3']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="345" height="210" />
            </td>
            <td colspan="2" width="375px" height="210px" valign="top">
                Others<br>
                <img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics5'])){ echo $resultPatientRecord['pedigree_graphics5']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="345" height="210" />
            </td>
        </tr>
        <tr>
            <td colspan="4">
        ...
        <tr align="center">
            <td colspan="2" width="375px" height="210px" valign="top">
                Frontal<br>
                <img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics2'])){ echo $resultPatientRecord['pedigree_graphics2']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="345" height="210" />
            </td>
            <td colspan="2" width="375px" height="210px" valign="top">
                Side<br>
                <img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics7'])){ echo $resultPatientRecord['pedigree_graphics7']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="345" height="210"/>
            </td>
        </tr>
        <tr align="center">
            <td colspan="2" width="375px" height="210px" valign="top">
                Shape of nose’s hole<br>
                <img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics6'])){ echo $resultPatientRecord['pedigree_graphics6']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="345" height="210" />
            </td>
            <td colspan="2" width="375px" height="210px" valign="top">
                Others<br>
                <img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics8'])){ echo $resultPatientRecord['pedigree_graphics8']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="345" height="210" />
            </td>
        </tr>
        <tr>
...
<div class="FilesUpload">
    <table class="DiagnosisForm">
        ...
        <tr><td align="center" valign="top" height="500px" width="700px"><img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics_other'])){ echo $resultPatientRecord['pedigree_graphics_other']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree"  width="690" height="500"></td></tr>
        ...
        <tr><td align="center" valign="top" height="210px" width="700px"><img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics10'])){ echo $resultPatientRecord['pedigree_graphics10']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="690" height="210"/></td></tr>
        <tr><td align="center"> Part 6D：Others receipt (2)</td></tr>
        <tr><td align="center" valign="top" height="210px" width="700px"><img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics11'])){ echo $resultPatientRecord['pedigree_graphics11']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="690" height="210" /></td></tr>
        <tr><td align="center"> Part 6E：Others receipt (3)</td></tr>
        <tr><td align="center" valign="top" height="210px" width="700px"><img border="0" src="<?PHP if(!empty($resultPatientRecord['pedigree_graphics12'])){ echo $resultPatientRecord['pedigree_graphics12']; }else{ echo 'img/user-pic.jpg'; } ?>" alt="Pedigree" width="690" height="210" /></td></tr>
    </table>
</div>
    ...
    <table style="text-align: center" class="ButtonZone">
        <tr class="ButtonZone">
            <td style="vertical-align:middle;" class="ButtonZone">
                ...
                <?php
//                    echo "PatientID: ".$resultPatientRecord['patientID']."<br> SEID: ".$seid."<br> Remark:".$resultPatientRecord['remark']."<br>";
                    if(($resultPatientRecord['patientID'] != $seid) || ($resultPatientRecord['remark'] == "2") || ($resultPatientRecord['remark'] == 2)){
                        echo "<input id='Backs' onClick=\"return saveData('cancels')\" type='button' value='Back' name='back'>";
                    }elseif (($resultPatientRecord['remark'] == "1") || ($resultPatientRecord['remark'] == 1) || ($resultPatientRecord['remark'] == "0") || ($resultPatientRecord['remark'] == 0)) {
                        echo "<input id='saves' onClick=\"return saveData('save')\" type='button' value='Save' name='save'>";
                        echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                        echo "<input id='cancels' onClick=\"return saveData('cancels')\" type='button' value='Cancel' name='close'>";
                        echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                        echo "<input id='submits' onClick=\"return saveData('sends')\" type='button' value='Submit' name='sends'>";
                    }
                ?>
            </td>
        </tr>
...
<input type="hidden" name="NCFMedicalNum" value="<?php echo $resultPatientRecord['NCFMedicalNum'];  ?>">
<input type="hidden" name="branch" value="1">
<input type="hidden" name="serialcode" value="1">
<input type="hidden" name="num" value="<?php echo $resultPatientRecord['num'];  ?>">
<input type="hidden" name="num2" value="<?php echo $resultPatientinfo['NCFMedicalNum'];  ?>">