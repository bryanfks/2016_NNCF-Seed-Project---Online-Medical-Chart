<?
	...
	if( (!empty($seid)) && (!empty($sepwd)) ){
		...
		//echo "Value: ".$nat."<br/> Value 2: ".$patid."<br/>";
		...
		@$query_data = mysql_query($sel_data);	
			...
			if(($nat == "KH") || ($nat == "VN") || ($nat == "PH") || ($nat == "MM")  || ($nat == "IN") || ($nat == "ID") || ($nat == "PK") || ($nat == "DM") || ($nat == "TW")){
				...
				echo "<!--";
				echo "\n";
				echo " location.href='chinaList.php';\n";
				echo "//-->";
				echo " </Script>";
			}else{
                  ...
                  <tr>
                   ...
                   <?PHP
				   		...
				   		while($result = mysql_fetch_array($query_data)){
							//$result["nationality"] != "KH") && ($result["nationality"] != "VN") && ($result["nationality"] != "PH") && ($result["nationality"] != "CN") && ($result["nationality"] != "MM") && ($result["nationality"] != "IN") && ($result["nationality"] != "ID") && ($result["nationality"] != "PK") && ($result["nationality"] != "DM") && ($result["nationality"] != "TW")
				   				if(($result["nationality"] != "KH") && ($result["nationality"] != "VN") && ($result["nationality"] != "PH") && ($result["nationality"] != "MM") && ($result["nationality"] != "IN") && ($result["nationality"] != "ID") && ($result["nationality"] != "PK") && ($result["nationality"] != "DM") && ($result["nationality"] != "TW")){
