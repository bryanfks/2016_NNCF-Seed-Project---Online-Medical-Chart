...
<HTML><HEAD>
    ...
    <SCRIPT language=javascript>
      ...
      function turnbacke(){
        location.href = "chinaList.php?c=st";
      } 
      function printRecord() {
            cpi = "<?PHP echo $CPIData; ?>";
            cpi2 = "<?PHP echo $CPIData2; ?>";
            n = "<?PHP echo $ncfmn; ?>";
            window.open('../chinaview-st-print.php?cpi='+cpi+'&cpi2='+cpi2+'&n='+n,'',config='');
        }
				//-->
		</SCRIPT>
</HEAD>
              ...
              <TR>
                <TD align=left>
                  ...
                  <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" bgColor=#ff9966 height=40 id="table14">
                    <TBODY>
                      <tr bgcolor="#FFFFFF">
                        <td align="center"><font size="2" face="Arial"><?PHP include("top.php"); ?></font></td>
                      </tr>
                      <tr bgcolor="#C0C0C0">
                        <td align="center"><font size="2" face="Arial"><?PHP include("select.php"); ?></font></td>
                      </tr>
                    	<TR>
                      		<TD>
                        					...
                        					<SPAN>
                        						<SELECT size=1 name="school"> 
                        							...
                        							<OPTION value="C" <?php if($resultChinaPatientinfo['school'] == "C"){echo "selected";} ?>>西安交通大学口腔医院</OPTION>
                                                             <OPTION value="C" <?php if($resultChinaPatientinfo['school'] == "S"){echo "selected";} ?>>中国医学科学院北京协和医院</OPTION>
                        						</SELECT>&nbsp;
                        					</SPAN>
                        				</B></I>
                        			</FONT>
