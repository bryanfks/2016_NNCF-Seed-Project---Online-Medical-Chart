<?PHP 
	...
	if(!empty($seid) && !empty($sepwd)){
		...
		$sel_data = "SELECT * FROM `member` ORDER BY `id` DESC";				
...
<SCRIPT LANGUAGE="javascript">
	<!--
		function fetch_Data(num){
			...
			location.href = "sys-mai-acc-edi.php?id="+result;
		}
	//-->
</SCRIPT>
</head>
...
<div align="center">
  ...
  <tr>
            <td width="100%" align="center" bgcolor="#F7EBC6">
              ...
              <div align="center">
                <table border="1" cellpadding="0" cellspacing="0" width="90%" bgcolor="#FF9966">
                  <tr>
                    <td width="100%">
                      <p align="center"><i><b><font face="Arial" color="#FFFFFF" size="3">Edit Annoucement</font></b></i></td>        
                  </tr>
                </table>
              </div>
              <p></td>
          ...
          <tr>
		    ...
		    echo "<td width='20%' align='center' valign='middle'><font size='3'><input type='button' value='EDIT' name='maintain' onClick='fetch_Data(".$i.")'></font></td>";
		    echo "</tr>";
		    $i++;
		   }
	              ?>
