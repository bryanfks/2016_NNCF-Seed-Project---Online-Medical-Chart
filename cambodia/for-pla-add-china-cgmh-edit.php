<?PHP
	...
	if(!empty($seid) && !empty($sepwd)){
		...
		/*
		$pat_NCFID_path = "/home/customer/seed-nncf.org/www/cambodia/photo/patientrecord/".$NCFID; 		// 设定病患照片路径
		...
		*/
		...
		/*
		$pat_NCFMedicalNum_path = "/home/customer/seed-nncf.org/www/cambodia/photo/medicalrecord/".$NCFMedicalNum; 		// 设定病患照片路径
		...
		*/
		...
		// 指：粘貼其他資料圖片
		$pat_NCFMedical_other = "/var/www/vhosts/seed-nncf.org/httpdocs/cambodia/photo/patientrecord/".$NCFMedicalNum; 		// 設定病患照片路徑
		...
		$img_path_patient = "/var/www/vhosts/seed-nncf.org/httpdocs/cambodia/photo/patientrecord/".$NCFID."/";
		...
		$selChinaPatientRecord = "SELECT * FROM `chinapatientrecord` WHERE NCFMedicalNum='".$num2."'";
