<?PHP
	...
	if(!empty($seid) && !empty($sepwd)){
		...
		// 搜寻病患基本资料
		$queryChinaPatientinfo = mysql_query("SELECT * FROM `chinapatient` WHERE num =".$CPIData."");
		$resultChinaPatientinfo = mysql_fetch_array($queryChinaPatientinfo);
		
		// 搜寻病患资料
		/*
		$selChinaPatientinfo = "SELECT * FROM `chinapatient` WHERE num =".$num."";
		$queryChinaPatientinfo = mysql_query("SELECT * FROM `chinapatient` WHERE num =".$num."");
		$resultChinaPatientinfo = mysql_fetch_array($queryChinaPatientinfo);
		*/
		$qMaxNCFID = mysql_query("SELECT MAX(serialcode) FROM `chinapatientrecord` WHERE NCFID='".$resultChinaPatientinfo['NCFID']."'");
		...
		if(($maxNums < 10) || ($maxNums != 10) || ($maxNums != "10")){
			...
			$NCFNumX = $resultChinaPatientinfo['NCFID']."1".$serialcode;
		}
		*/
		$get_time = getdate();
		...
		if(!empty($maxNums)){	// If $max !empty than split no
			...
			if($no_date == $date){
				...
				$NCFNumX = "KH".$date.$flow_no;
			}else{
				$NCFNumX = "KH".$date."0001";	
			}
		}else{
			$NCFNumX = "KH".$date."0001";
		}
		*/
		//echo "New NCFID: ".$NCFNumX."<br>";
...
<form name="china_medical" enctype="multipart/form-data" method="post" action="for-pla-add-china-cgmh-save2.php">
<div align="center">
                        ...
                        <b style='mso-bidi-font-weight:normal'><span lang=EN-US>
        					<font size="5" face="Times New Roman">
        						<select size="1" name="school">
									...
									<OPTION value="NPH" <? if($resultChinaPatientinfo['school'] == "NPH"){ echo "selected"; } ?>>National Pediatric Hospital</OPTION>
									<!-- 
                                ...
                                <span lang=EN-US style='font-family:Calibri'><o:p></o:p></span>
                               </td>
					</tr>
				</table>
						</div>
...
&nbsp;</o:p></span><font face="Times New Roman" size="3"><input type="checkbox" name="diagnosis_bilateral_cleft_lip_2" value="BCL" <? if(($resultChinaPatientinfo['diagnosis_bilateral_cleft_lip_2'] == "BCL") || ($resultChinaPatientinfo['diagnosis_bilateral_cleft_lip_2'] == "1")){ echo "checked"; } ?>></font><span lang=EN-US style='font-family:Times New Roman'>Bilateral 
          ...
          <span style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>--- </span>
						<font face="Times New Roman" size="3">
						<input type="radio" value="C" name="incomplete_main" <? if($resultChinaPatientinfo['complete_main'] == "C"){ echo "checked"; } ?>></font><span lang=EN-US style='font-family:Times New Roman'>Complete 
						( </span><font face="Times New Roman" size="3">
						...
						</o:p>&nbsp;</span><font face="Times New Roman" size="3"><input type="checkbox" name="Combined_with_other_craniofacial_disorders" value="Other" <? if($resultChinaPatientinfo['Combined_with_other_craniofacial_disorders'] == "Other"){ echo "checked"; } ?>></font><span lang=EN-US style='font-family:Times New Roman'>Combined 
						with Other Craniofacial Deformities</span><font face="Times New Roman"><span style='mso-ascii-font-family:
          Calibri;mso-hansi-font-family:Calibri'>：</span></font><font face="Times New Roman" size="4"><input type="text" name="Combined_with_other_craniofacial_disorders_text" size="50" value=""></font><o:p></o:p></td>
					</tr>
					<tr>
...
&nbsp; Family Condition</span></font></td>
					<td colspan="4">
					<font size="4"><span style="font-family: Times New Roman">&nbsp;<font face="Times New Roman"><textarea rows="5" name="descriptionCaseFamily" cols="60" value=""></textarea></font></span></font></td>
				</tr>
				<tr>
					<td colspan="2">
					<font size="4">
...
&nbsp; (average)</span></font></td>
          ...
          lang=EN-US style='font-family:Calibri'><o:p></o:p></span></td>
					<td width="353"><?php //echo $NCFNumX;  ?>&nbsp;</td>
				</tr>
			</table>
			</div>
						</td>
...
&nbsp; Anesthesia</span></font><span
          ...
          <p style="line-height: 150%">
          <font size="4">
			<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">&nbsp;<font face="Times New Roman"><input type="radio" value="GA" name="Anesthesia" <?php if($resultChinaPatientRecord['Anesthesia'] =="GA"){echo "selected";}  ?>></font><span style='font-family:Times New Roman;mso-hansi-font-family:新細明體'>General
          Anesthesia<br>
			</span>&nbsp;<font face="Times New Roman"><input type="radio" value="LA" name="Anesthesia" <?php if($resultChinaPatientRecord['Anesthesia'] =="LA"){echo "selected";}  ?>></font><span style='font-family:Times New Roman;mso-hansi-font-family:新細明體'>Local Anesthesia</span></span></font><o:p></o:p></td>
				</tr>
				<tr>
					<td width="159"><font size="4">
...
&nbsp; Anesthesiologist</span></font></td>
          ...
          Flap Repair<br>
					...
					<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">&nbsp;<font face="Times New Roman"><input type="radio" value="MOTH" name="surgeryType"></font><span style='font-family:Times New Roman;mso-hansi-font-family:新細明體'>Others</span>： 
          ...
          Variant <font face="Times New Roman"> <input type="radio" value="Mohler" name="repairTypeUnilateralcleftlip"></font>Mohler</span></font><font face="Times New Roman"><o:p><br>
					...
					<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">&nbsp;&nbsp;<font face="Times New Roman"><input type="radio" value="Others" name="repairTypeUnilateralcleftlip"></font>Others：</span><span style="font-family: Times New Roman"><font face="Times New Roman"><input type="text" name="repairTypeUnilateralcleftlip_text" size="27" value=""></font></span></font><o:p></o:p></td>
				</tr>
				<tr>
					<td colspan="3">
					<p style="line-height: 150%">
          ...
          Flap <font face="Times New Roman"> <input type="radio" value="Others" name="repairTypeBilateralcleftlip"></font>Others：</span><span style="font-family: Times New Roman"><font face="Times New Roman"><input type="text" name="repairTypeBilateralcleftlip_text" size="27" value=""></font></span></font><o:p></o:p></td>
				</tr>
				<tr>
					<td colspan="3">
          ...
          Variant <font face="Times New Roman" size="3"><input type="radio" value="Furlow" name="repairTypeCleftpalate"></font>Furlow
					...
					&nbsp;&nbsp;<font face="Times New Roman"><input type="radio" value="Others" name="repairTypeCleftpalate"></font>Others：</font></span><font size="4"><span style="font-family: Times New Roman"><font face="Times New Roman"><input type="text" name="repairTypeCleftpalate_text" size="27" value=""></font></span></font><o:p></o:p></td>
				</tr>
				<tr>
					<td colspan="3">
					<p style="line-height: 150%">
...
&nbsp;&nbsp;&nbsp; --</span><span style='font-family:Times New Roman; mso-hansi-font-family:新細明體'>Date 
					(Pre-Surgery)</span><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span><span style='font-family:Times New Roman; mso-hansi-font-family:新細明體'><input type="text" name="beforeSurgeryYear" size="2" value="">/ <input type="text" name="beforeSurgeryMonth" size="1" value="">/ <input type="text" name="beforeSurgeryDay" size="1" value=""></span></font><div align="center">
						<table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="420">
							<tr>
								...
								<font size="4">Frontal<br><input type="file" size="25" name="pedigree_graphics1"></font></span></td>
								<td valign="top" align="center" width="345" height="210">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Side<br><input type="file" size="25" name="pedigree_graphics4"></font></span></td>
							</tr>
							<tr>
								<td valign="top" align="center" width="345" height="210">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Shape of Nose’s Hole<br><input type="file" size="25" name="pedigree_graphics3"></font></span></td>
								<td valign="top" align="center" width="345" height="210">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Other<br><input type="file" size="25" name="pedigree_graphics5"></font></span></td>
							</tr>
						</table>
					</div>
					<font size="4">
					<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">&nbsp;&nbsp;&nbsp;&nbsp; 
					--Date (Post-Surgery)：<input type="text" name="afterSurgeryYear" size="2" value="">/ <input type="text" name="afterSurgeryMonth" size="1" value="">/ <input type="text" name="afterSurgeryDay" size="1" value=""></span></font><div align="center">
						<table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="420">
							<tr>
								<td valign="top" height="210" width="345" align="center">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Frontal<br><input type="file" size="25" name="pedigree_graphics2"></font></span></td>
								<td valign="top" height="210" width="345" align="center">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Side<br><input type="file" size="25" name="pedigree_graphics7"></font></span></td>
							</tr>
							<tr>
								<td valign="top" height="210" width="345" align="center">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Shape of Nose’s Hole<br><input type="file" size="25" name="pedigree_graphics6"></font></span></td>
								<td valign="top" height="210" width="345" align="center">
								<span style="color: rgb(0, 0, 0); font-family: Times New Roman; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(238, 238, 238); display: inline !important; float: none">
								<font size="4">Other<br><input type="file" size="25" name="pedigree_graphics8"></font></span></td>
							</tr>
						</table>
						</div>
					</td>
				...
				<tr>
					...
					<font size="4">
					<span style='font-family:Times New Roman;
          mso-hansi-font-family:新細明體'>&nbsp; Subsidy from Other<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></font>
					<span style="font-family: Times New Roman">
					<font face="Times New Roman" size="4">
			<input type="checkbox" name="MSOther" value="1"></font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><span style='font-family:Times New Roman;mso-hansi-font-family:新細明體'>Others</span>：</span><span style="font-family: Times New Roman"><font face="Times New Roman"><input type="text" name="MSOther_text" size="42" value=""></font><br>
					</span>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; P</span>roject Name：</span><span style="font-family: Times New Roman"><font face="Times New Roman"><input type="text" name="LAitem" size="34" value=""></font><br>
					...
					<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">&nbsp;&nbsp; Other Subsidy<span
...
&nbsp;&nbsp; 3.Other：US$ </span>
					<span style="font-family: Times New Roman">
									<font face="Times New Roman">
					<input type="text" name="OtherPay" size="6" value=""></font></span><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">; </span></font></td>
									<td valign="top">
									<span style="font-family: Times New Roman">
...
&nbsp; 2.</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Patient 
					...
					<span style="font-family: Times New Roman">
									<font face="Times New Roman" size="4">
					<input type="text" name="PatientSOT" size="6" value=""></font></span></td>
								</tr>
								<tr>
									<td colspan="2" height="30">
				...
				<tr>
							...
							<table border="1" width="700" cellspacing="0" cellpadding="0">
								<tr>
									...
									Hospital)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="500">
										<tr>
											<td valign="top" align="center"><br><input type="file" size="25" name="pedigree_graphics_other"></td>
										</tr>
									</table>
					<font size="4">
									<span style='font-family:Times New Roman; mso-hansi-font-family:新細明體'>
					&nbsp;</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">* 
									...
									Coordinator and Program Director)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="250">
										<tr>
											<td valign="top" align="center"><br><input type="file" size="25" name="pedigree_graphics9"></td>
										</tr>
									</table>
									<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
									<font size="4">Part 6C</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Other Receipt (1)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="210">
										<tr>
											<td valign="top" align="center"><br><input type="file" size="25" name="pedigree_graphics10"></td>
										</tr>
									</table>
									<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
									<font size="4">Part 6D</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Other Receipt (2)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="210">
										<tr>
											<td valign="top" align="center"><br><input type="file" size="25" name="pedigree_graphics11"></td>
										</tr>
									</table>
									<span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">
									<font size="4">Part 6E</font></span><font size="4"><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體">：</span></font><span style="font-family: Times New Roman; mso-hansi-font-family: 新細明體"><font size="4">Other Receipt (3)</font></span><table border="1" width="690" cellspacing="0" cellpadding="0" style="border-style: dashed; border-width: 1px; padding-left: 0; padding-right: 0; padding-top: 0px; padding-bottom: 0px" height="210">
										<tr>
											<td valign="top" align="center"><br><input type="file" size="25" name="pedigree_graphics12"></td>
										</tr>
									</table>
									</td>
								</tr>
...
<!-- <input type="hidden" name="NCFMedicalNum" value="<? //echo $NCFNumX; ?>"> -->
<input type="hidden" name="branch" value="1">
<input type="hidden" name="serialcode" value="<? echo $serialcode; ?>">
