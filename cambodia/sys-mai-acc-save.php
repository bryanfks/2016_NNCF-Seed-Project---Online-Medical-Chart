<? 
	...
	if(!empty($seid) && !empty($sepwd)){
		...
		$PicData = $_POST['picpaths'];
			...
			if(!empty($filename)){
				$oldmask = umask(0);														
				@mkdir("/home/customer/seed-nncf.org/www/photo/member/".$id_Post, 0777);			// create new image fold by new member fold
				umask($oldmask);															
				$img_path = "/home/customer/seed-nncf.org/www/photo/member/".$id_Post."/";			// photo on server path.
