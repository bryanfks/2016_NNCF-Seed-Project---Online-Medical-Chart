...
<form name="china_medical" enctype="multipart/form-data" method="post" action="chinaviewSave.php">
<div align="center">
  <center>
      ...
      <td width="100%">
        <div align="center">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-style: solid; border-width: 2" height="1">
            ...
            <tr>
              <td width="100%" height="16" align="center"><font size="3" face="Arial"><?PHP include("/home/customer/seed-nncf.org/www/chinaSelect.php"); ?></font></td>
            </tr>
            <tr>
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1" width="637">
                          ...
                          <label for="checkbox11">
							...
							<input id="incomplete4" type="radio" value="IC" name="incomplete_main" <? if($resultChinaPatientinfo['incomplete_main'] == "IC"){ echo "checked"; } ?>/></label>不完全性 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                          ...
                          <label for="checkbox11">
							...
							<input id="incomplete5" type="radio" value="C" name="complete_main" <? if($resultChinaPatientinfo['complete_main'] == "C"){ echo "checked"; } ?>/></label> 
...
<img border="0" src="<?PHP if(!empty($resultChinaPatientinfo['pedigree_graphics'])){ echo $resultChinaPatientinfo['pedigree_graphics']; }else{ echo 'images/user-pic.jpg'; } ?>" alt="Pedigree" width="325" height="285"></font></td>
                ...
                <div align="center">
                  ...
                  <table border="0" cellspacing="1" width="780">
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1" width="611"><?php echo $resultChinaPatientinfo['NCFMedicalNum'];  ?></td>
