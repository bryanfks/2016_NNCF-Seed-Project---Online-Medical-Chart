      ...
      <td width="100%">
        <div align="center">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-style: solid; border-width: 2" height="1">
            ...
            <tr>
              <td width="100%" height="100%" align="center" bgcolor="#FFF3DE"><font size="3">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
				...
				<font color="#000000" size="5">西安交通大学口腔医院清寒唇腭裂患者补助申请表</font></i></b></span><font size="5">
                  ...
                  <table border="0" cellspacing="1" width="780">
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1">
						...
						<font size="3">&nbsp;<input id="orthodontics1" maxLength="20" name="orthodontics" size="20">&nbsp;</font></td>
                ...
                <div align="center">
                  ...
                  <table border="0" cellspacing="1" width="780">
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1" width="291"><font size="3">&nbsp;<input id="idno2" maxLength="20" name="idno" size="20">&nbsp; 

                            <input type="submit" value="查询" name="B1"></font></td>
                      ...
                      <td style="border-style: solid; border-width: 1" width="251">
						...
						<font size="3">&nbsp;<input id="MedicalRecordNumber2" maxLength="20" name="MedicalRecordNumber" size="20"></font></td>
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1" width="291">
						...
						<font size="3">&nbsp;<input id="name2" maxLength="20" name="name" size="20"></font></td>
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1" colspan="3" width="667">
						...
						&nbsp;<input id="phone3" name="phone0" size="32"></font></td>
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1" width="637">
                          ...
                          <label for="checkbox11">
							...
							<input id="incomplete4" type="radio" value="V1" name="incomplete1"></label>不完全性 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                          ...
                          <label for="checkbox11">
							...
							<input id="incomplete5" type="radio" value="V1" name="incomplete2"></label> 

                          完全性 ( <input id="complete0" type="radio" value="U" name="complete">&#21333;&#20391; <input id="complete1" type="radio" value="B" name="complete">双侧 

							)</font></p>                                

                          <p><font size="3">&nbsp;<input id="beforeSurgery_21" type="checkbox" value="PO" name="beforeSurgery_10">牙槽突裂 

							(                                 

                          <input id="diagnosis_unilateral_cleft_lip3" type="radio" value="C" name="diagnosis_unilateral_cleft_lip">完全性                                 

                          <input id="diagnosis_unilateral_cleft_lip4" type="radio" value="IC" name="diagnosis_unilateral_cleft_lip">不完全性                                 

                          <input id="diagnosis_unilateral_cleft_lip5" type="radio" value="CK" name="diagnosis_unilateral_cleft_lip">&#38544;裂 
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1"><font size="3">*</font>个案<font size="3">之前是否接受&#36807;任何唇&#33133;裂治疗？</font><p>
						...
						&nbsp;<font size="3"><label><input id="Cleft_lip_and_palate_surgery0" type="radio" value="Y" name="Cleft_lip_and_palate_surgery">是</label></font></p>
                          ...
                          <p><font size="3">&nbsp; <label>&nbsp;<input id="beforeSurgery_11" type="checkbox" value="1LNR" name="beforeSurgery_1">一期唇鼻修复</label>                                 

                          <label><input id="beforeSurgery_12" type="checkbox" value="1BLANR" name="beforeSurgery_2">一期唇鼻修复</label>                                 

                          <label><input id="beforeSurgery_13" type="checkbox" value="1CPR" name="beforeSurgery_3">一期裂修复</label>                                 
                          ...
                          <p><font size="3">&nbsp;&nbsp; <input id="beforeSurgery_17" type="checkbox" value="2CPR" name="beforeSurgery_7">二期裂修复                  

                          <input id="beforeSurgery_18" type="checkbox" value="LR" name="beforeSurgery_8">唇鼻整形                  

                          <input id="beforeSurgery_19" type="checkbox" value="AB" name="beforeSurgery_9">槽植骨                  

                          <input id="beforeSurgery_20" type="checkbox" value="PO" name="beforeSurgery_10">前正畸                  
                ...
                <div align="center">
                  ...
                  <table border="0" cellspacing="1" width="780">
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1" width="85"><font size="3">&nbsp;<input id="fatherAge1" maxLength="3" size="4" name="fatherAge"> 
                      ...
                      <td style="border-style: solid; border-width: 1" width="179">
						...
						<font size="3">&nbsp;<input id="fatherProfession_main1" maxLength="20" name="fatherProfession_main" size="20"></font></td>

                      <td style="border-style: solid; border-width: 1" width="99">

						<font size="3"> &nbsp;教育程度</font></td> 

                      <td style="border-style: solid; border-width: 1" width="221"><font size="3"><label>&nbsp;<input id="fatherProfession5" type="radio" value="大&#19987;以上" name="fatherProfession">大&#19987;以上</label><br>

                          <label>&nbsp;<input id="fatherProfession6" type="radio" value="中&#23398;(&#19987;)" name="fatherProfession">中

						学(&#19987;)</label><br>

                          <label>&nbsp;<input id="fatherProfession7" type="radio" value="小&#23398;" name="fatherProfession">小

						学</label><br>

                          <label>&nbsp;<input id="fatherProfession8" type="radio" value="&#35782;字" name="fatherProfession">&#35782;字</label> 

                          <label>&nbsp;<input id="fatherProfession9" type="radio" value="不&#35782;字" name="fatherProfession">不&#35782;字</label></font></td>     
                  ...
                  <table border="0" cellspacing="1" width="780">
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1"><font size="3">&nbsp;     
                        ...
                        <input id="income1" maxLength="7" size="9" name="income">         
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1"><font size="3"><label for="fixedExpenditure1">&nbsp;1.    
                          ...
                          <input id="fixedExpenditure13" maxLength="30" size="30" name="fixedExpenditure1"></label><br>

                          <label for="fixedExpenditure2">&nbsp;2. <input id="fixedExpenditure14" maxLength="30" size="30" name="fixedExpenditure2"></label><br>   

                          <label for="fixedExpenditure3">&nbsp;3. <input id="fixedExpenditure15" maxLength="30" size="30" name="fixedExpenditure3"></label><br>   

                          <label for="fixedExpenditure4">&nbsp;4. <input id="fixedExpenditure16" maxLength="30" size="30" name="fixedExpenditure4"></label></font></td> 
                  ...
                  <table border="0" cellspacing="1" width="780">
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1" colspan="3">
                        ...
                        <p><font size="3">&nbsp; &nbsp;<input id="repairTypeBilateralcleftlip3" type="radio" value="Straight Line" name="repairTypeBilateralcleftlip">Bone         
                  ...
                  <table border="0" cellspacing="1" width="780">
                    ...
                    <tr>
                      ...
                      <td style="border-style: solid; border-width: 1">
                          ...
                          <p><strong><font size="3">&nbsp;<input id="transportationSubsidies4" type="checkbox" value="1" name="transportationSubsidies2">交通费补助：</font></strong></p>
