            ...
            <td width="100%" align="center" bgcolor="#C0C0C0" height="29">
              <div align="center">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td width="20%" align="center"><font size="3" face="Arial"><select size="1" name="select1" onChange="javascript:window.location = this.options.value">
                        <option selected>Record Management</option>
                        <option value="rec-sea-pat.php">Search Patient</option>
                        <option value="rec-add-pat.php">Add Patient</option>
                      </select></font></td>
                    <td width="20%" align="center"><font size="3" face="Arial"><select size="1" name="select2" onChange="javascript:location = this.options.value">
